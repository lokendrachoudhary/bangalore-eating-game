...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ao(e,t,n){let r=new Float32Array(Ga),i=new U(0,1,0);return new ki({name:`SphericalGaussianBlur`,defines:{n:Ga,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:co(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function oo(){return new ki({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:co(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function so(){return new ki({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:co(),fragmentShader:`
	...
	`}var lo=class extends kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new li([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Fs={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Is(e,t){let n=Fs[t];return n===void 0?(R(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Ls=new U;function Rs(){return G.getLuminanceCoefficients(Ls),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Ls.x.toFixed(4)}, ${Ls.y.toFixed(4)}, ${Ls.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Ds(i,i.VERTEX_SHADER,y),S=Ds(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Ns(i,x,`vertex`),n=Ns(i,S,`fragment`);z(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
...
}`,Rc=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new pi(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new ki({vertexShader:Ic,fragmentShader:Lc,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new q(new vi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},zc=class extends nt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,u=null,d=null,f=null,p=null,h=null,g=typeof XRWebGLBinding<`u`,_=new Rc,v={},b=t.getContextAttributes(),x=null,S=null,C=[],D=[],ee=new H,O=null,k=new la;k.viewport=new Dt;let te=new la;te.viewport=new Dt;let ne=[k,te],A=new _a,re=null,j=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new ln,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new ln,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new ln,C[e]=t),t.getHandSpace()};function M(e){let t=D.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ie(){r.removeEventListener(`select`,M),r.removeEventListener(`selectstart`,M),r.removeEventListener(`selectend`,M),r.removeEventListener(`squeeze`,M),r.removeEventListener(`squeezestart`,M),r.removeEventListener(`squeezeend`,M),r.removeEventListener(`end`,ie),r.removeEventListener(`inputsourceschange`,ae);for(let e=0;e<C.length;e++){let t=D[e];t!==null&&(D[e]=null,C[e].disconnect(t))}re=null,j=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(x),p=null,f=null,d=null,r=null,S=null,fe.stop(),n.isPresenting=!1,e.setPixelRatio(O),e.setSize(ee.width,ee.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&R(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&R(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return h},this.getSession=function(){return r},this.setSession=async function(u){if(r=u,r!==null){if(x=e.getRenderTarget(),r.addEventListener(`select`,M),r.addEventListener(`selectstart`,M),r.addEventListener(`selectend`,M),r.addEventListener(`squeeze`,M),r.addEventListener(`squeezestart`,M),r.addEventListener(`squeezeend`,M),r.addEventListener(`end`,ie),r.addEventListener(`inputsourceschange`,ae),b.xrCompatible!==!0&&await t.makeXRCompatible(),O=e.getPixelRatio(),e.getSize(ee),g&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;b.depth&&(o=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=b.stencil?E:T,a=b.stencil?y:m);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};d=this.getBinding(),f=d.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new kt(f.textureWidth,f.textureHeight,{format:w,type:l,depthTexture:new di(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new kt(p.framebufferWidth,p.framebufferHeight,{format:w,type:l,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),fe.setContext(r),fe.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function ae(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=D.indexOf(n);r>=0&&(D[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=D.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=D.length){D.push(n),r=e;break}else if(D[e]===null){D[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let N=new U,oe=new U;function se(e,t,n){N.setFromMatrixPosition(t.matrixWorld),oe.setFromMatrixPosition(n.matrixWorld);let r=N.distanceTo(oe),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function ce(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),A.near=te.near=k.near=t,A.far=te.far=k.far=n,(re!==A.near||j!==A.far)&&(r.updateRenderState({depthNear:A.near,depthFar:A.far}),re=A.near,j=A.far),A.layers.mask=e.layers.mask|6,k.layers.mask=A.layers.mask&-5,te.layers.mask=A.layers.mask&-3;let i=e.parent,a=A.cameras;ce(A,i);for(let e=0;e<a.length;e++)ce(a[e],i);a.length===2?se(A,k,te):A.projectionMatrix.copy(k.projectionMatrix),le(e,A,i)};function le(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=at*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return A},this.getFoveation=function(){if(!(f===null&&p===null))return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(A)},this.getCameraTexture=function(e){return v[e]};let ue=null;function de(t,i){if(u=i.getViewerPose(c||a),h=i,u!==null){let t=u.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==A.cameras.length&&(A.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=d.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=ne[n];o===void 0&&(o=new la,o.layers.enable(n),o.viewport=new Dt,ne[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(A.matrix.copy(o.matrix),A.matrix.decompose(A.position,A.quaternion,A.scale)),i===!0&&A.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&g){d=n.getBinding();let e=d.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&g){e.state.unbindTexture(),d=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new pi,v[n]=e);let t=d.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=D[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}ue&&ue(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),h=null}let fe=new Ma;fe.setAnimationLoop(de),this.setAnimationLoop=function(e){ue=e},this.dispose=function(){}}},Bc=new Ht,Vc=new Mt;function Hc(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,Ti(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,Bc.copy(o),Bc.x*=-1,Bc.y*=-1,Bc.z*=-1,a.isCubeTexture&&a.isRenderTargetTexture===!1&&(Bc.y*=-1,Bc.z*=-1),e.envMapRotation.value.setFromMatrix4(Vc.makeRotationFromEuler(Bc)),e.flipEnvMap.value=a.isCubeTexture&&a.isRenderTargetTexture===!1?-1:1,e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function Uc(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(m(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,g));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return z(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let t=0,n=r.length;t<n;t++){let n=Array.isArray(r[t])?r[t]:[r[t]];for(let r=0,i=n.length;r<i;r++){let i=n[r];if(p(i,t,r,a)===!0){let t=i.__offset,n=Array.isArray(i.value)?i.value:[i.value],r=0;for(let a=0;a<n.length;a++){let o=n[a],s=h(o);typeof o==`number`||typeof o==`boolean`?(i.__data[0]=o,e.bufferSubData(e.UNIFORM_BUFFER,t+r,i.__data)):o.isMatrix3?(i.__data[0]=o.elements[0],i.__data[1]=o.elements[1],i.__data[2]=o.elements[2],i.__data[3]=0,i.__data[4]=o.elements[3],i.__data[5]=o.elements[4],i.__data[6]=o.elements[5],i.__data[7]=0,i.__data[8]=o.elements[6],i.__data[9]=o.elements[7],i.__data[10]=o.elements[8],i.__data[11]=0):(o.toArray(i.__data,r),r+=s.storage/Float32Array.BYTES_PER_ELEMENT)}e.bufferSubData(e.UNIFORM_BUFFER,t,i.__data)}}}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function m(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=h(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function h(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?R(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):R(`WebGLRenderer: Unsupported uniform value type.`,e),t}function g(t){let n=t.target;n.removeEventListener(`dispose`,g);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function _(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:_}}var Wc=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Gc=null;function Kc(){return Gc===null&&(Gc=new ei(Wc,16,16,O,g),Gc.name=`DFG_LUT`,Gc.minFilter=o,Gc.magFilter=o,Gc.wrapS=t,Gc.wrapT=t,Gc.generateMipmaps=!1,Gc.needsUpdate=!0),Gc}var qc=class{constructor(e={}){let{canvas:t=Je(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:u=!1,powerPreference:d=`default`,failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:b=l}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);x=n.getContextAttributes().alpha}else x=a;let S=b,C=new Set([te,k,ee]),w=new Set([l,m,f,y,_,v]),T=new Uint32Array(4),E=new Int32Array(4),D=null,O=null,ne=[],A=[],re=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let j=this,M=!1;this._outputColorSpace=Re;let ie=0,ae=0,N=null,oe=-1,se=null,ce=new Dt,le=new Dt,ue=null,de=new K(0),fe=0,pe=t.width,me=t.height,he=1,ge=null,_e=null,ve=new Dt(0,0,pe,me),ye=new Dt(0,0,pe,me),be=!1,xe=new ci,Se=!1,Ce=!1,we=new Mt,Te=new U,Ee=new Dt,De={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Oe=!1;function ke(){return N===null?he:1}let P=n;function Ae(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:p};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r183`),t.addEventListener(`webglcontextlost`,ot,!1),t.addEventListener(`webglcontextrestored`,B,!1),t.addEventListener(`webglcontextcreationerror`,st,!1),P===null){let t=`webgl2`;if(P=Ae(t,e),P===null)throw Ae(t)?Error(`Error creating WebGL context with your selected attributes.`):Error(`Error creating WebGL context.`)}}catch(e){throw z(`WebGLRenderer: `+e.message),e}let je,Me,F,Ne,I,L,Pe,Fe,Ie,Le,Be,Ve,He,Ue,Ge,Ke,qe,Ye,Xe,Qe,tt,nt,rt;function it(){je=new fo(P),je.init(),tt=new Fc(P,je),Me=new Va(P,je,e,tt),F=new Nc(P,je),Me.reversedDepthBuffer&&h&&F.buffers.depth.setReversed(!0),Ne=new ho(P),I=new pc,L=new Pc(P,je,F,I,Me,tt,Ne),Pe=new uo(j),Fe=new Na(P),nt=new za(P,Fe),Ie=new po(P,Fe,Ne,nt),Le=new _o(P,Ie,Fe,nt,Ne),Ye=new go(P,Me,L),Ge=new Ha(I),Be=new fc(j,Pe,je,Me,nt,Ge),Ve=new Hc(j,I),He=new _c,Ue=new wc(je),qe=new Ra(j,Pe,F,Le,x,s),Ke=new Mc(j,Le,Me),rt=new Uc(P,Ne,Me,F),Xe=new Ba(P,je,Ne),Qe=new mo(P,je,Ne),Ne.programs=Be.programs,j.capabilities=Me,j.extensions=je,j.properties=I,j.renderLists=He,j.shadowMap=Ke,j.state=F,j.info=Ne}it(),S!==1009&&(re=new yo(S,t.width,t.height,r,i));let at=new zc(j,P);this.xr=at,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){let e=je.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=je.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return he},this.setPixelRatio=function(e){e!==void 0&&(he=e,this.setSize(pe,me,!1))},this.getSize=function(e){return e.set(pe,me)},this.setSize=function(e,n,r=!0){if(at.isPresenting){R(`WebGLRenderer: Can't change size while VR device is presenting.`);return}pe=e,me=n,t.width=Math.floor(e*he),t.height=Math.floor(n*he),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),re!==null&&re.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(pe*he,me*he).floor()},this.setDrawingBufferSize=function(e,n,r){pe=e,me=n,he=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){console.error(`THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){console.warn(`THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}re.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(ce)},this.getViewport=function(e){return e.copy(ve)},this.setViewport=function(e,t,n,r){e.isVector4?ve.set(e.x,e.y,e.z,e.w):ve.set(e,t,n,r),F.viewport(ce.copy(ve).multiplyScalar(he).round())},this.getScissor=function(e){return e.copy(ye)},this.setScissor=function(e,t,n,r){e.isVector4?ye.set(e.x,e.y,e.z,e.w):ye.set(e,t,n,r),F.scissor(le.copy(ye).multiplyScalar(he).round())},this.getScissorTest=function(){return be},this.setScissorTest=function(e){F.setScissorTest(be=e)},this.setOpaqueSort=function(e){ge=e},this.setTransparentSort=function(e){_e=e},this.getClearColor=function(e){return e.copy(qe.getClearColor())},this.setClearColor=function(){qe.setClearColor(...arguments)},this.getClearAlpha=function(){return qe.getClearAlpha()},this.setClearAlpha=function(){qe.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(N!==null){let t=N.texture.format;e=C.has(t)}if(e){let e=N.texture.type,t=w.has(e),n=qe.getClearColor(),r=qe.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,P.clearBufferuiv(P.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,P.clearBufferiv(P.COLOR,0,E))}else r|=P.COLOR_BUFFER_BIT}t&&(r|=P.DEPTH_BUFFER_BIT),n&&(r|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&P.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener(`webglcontextlost`,ot,!1),t.removeEventListener(`webglcontextrestored`,B,!1),t.removeEventListener(`webglcontextcreationerror`,st,!1),qe.dispose(),He.dispose(),Ue.dispose(),I.dispose(),Pe.dispose(),Le.dispose(),nt.dispose(),rt.dispose(),Be.dispose(),at.dispose(),at.removeEventListener(`sessionstart`,ft),at.removeEventListener(`sessionend`,W),pt.stop()};function ot(e){e.preventDefault(),Ze(`WebGLRenderer: Context Lost.`),M=!0}function B(){Ze(`WebGLRenderer: Context Restored.`),M=!1;let e=Ne.autoReset,t=Ke.enabled,n=Ke.autoUpdate,r=Ke.needsUpdate,i=Ke.type;it(),Ne.autoReset=e,Ke.enabled=t,Ke.autoUpdate=n,Ke.needsUpdate=r,Ke.type=i}function st(e){z(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function ct(e){let t=e.target;t.removeEventListener(`dispose`,ct),lt(t)}function lt(e){V(e),I.remove(e)}function V(e){let t=I.get(e).programs;t!==void 0&&(t.forEach(function(e){Be.releaseProgram(e)}),e.isShaderMaterial&&Be.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=De);let o=i.isMesh&&i.matrixWorld.determinant()<0,s=St(e,t,n,r,i);F.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Ie.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;nt.setup(i,r,s,n,c);let h,g=Xe;if(c!==null&&(h=Fe.get(c),g=Qe,g.setIndex(h)),i.isMesh)r.wireframe===!0?(F.setLineWidth(r.wireframeLinewidth*ke()),g.setMode(P.LINES)):g.setMode(P.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),F.setLineWidth(e*ke()),i.isLineSegments?g.setMode(P.LINES):i.isLineLoop?g.setMode(P.LINE_LOOP):g.setMode(P.LINE_STRIP)}else i.isPoints?g.setMode(P.POINTS):i.isSprite&&g.setMode(P.TRIANGLES);if(i.isBatchedMesh)if(i._multiDrawInstances!==null)$e(`WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection.`),g.renderMultiDrawInstances(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount,i._multiDrawInstances);else if(je.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Fe.get(c).bytesPerElement:1,o=I.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(P,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function H(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,yt(e,t,n),e.side=0,e.needsUpdate=!0,yt(e,t,n),e.side=2):yt(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),O=Ue.get(n),O.init(t),A.push(O),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(O.pushLight(e),e.castShadow&&O.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(O.pushLight(e),e.castShadow&&O.pushShadow(e))}),O.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];H(a,n,e),r.add(a)}else H(t,n,e),r.add(t)}),O=A.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){I.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}je.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let ut=null;function dt(e){ut&&ut(e)}function ft(){pt.stop()}function W(){pt.start()}let pt=new Ma;pt.setAnimationLoop(dt),typeof self<`u`&&pt.setContext(self),this.setAnimationLoop=function(e){ut=e,at.setAnimationLoop(e),e===null?pt.stop():pt.start()},at.addEventListener(`sessionstart`,ft),at.addEventListener(`sessionend`,W),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){z(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(M===!0)return;let n=at.enabled===!0&&at.isPresenting===!0,r=re!==null&&(N===null||n)&&re.begin(j,N);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),at.enabled===!0&&at.isPresenting===!0&&(re===null||re.isCompositing()===!1)&&(at.cameraAutoUpdate===!0&&at.updateCamera(t),t=at.getCamera()),e.isScene===!0&&e.onBeforeRender(j,e,t,N),O=Ue.get(e,A.length),O.init(t),A.push(O),we.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),xe.setFromProjectionMatrix(we,We,t.reversedDepth),Ce=this.localClippingEnabled,Se=Ge.init(this.clippingPlanes,Ce),D=He.get(e,ne.length),D.init(),ne.push(D),at.enabled===!0&&at.isPresenting===!0){let e=j.xr.getDepthSensingMesh();e!==null&&mt(e,t,-1/0,j.sortObjects)}mt(e,t,0,j.sortObjects),D.finish(),j.sortObjects===!0&&D.sort(ge,_e),Oe=at.enabled===!1||at.isPresenting===!1||at.hasDepthSensing()===!1,Oe&&qe.addToRenderList(D,e),this.info.render.frame++,Se===!0&&Ge.beginShadows();let i=O.state.shadowsArray;if(Ke.render(i,e,t),Se===!0&&Ge.endShadows(),this.info.autoReset===!0&&this.info.reset(),(r&&re.hasRenderPass())===!1){let n=D.opaque,r=D.transmissive;if(O.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];gt(n,r,e,a)}Oe&&qe.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];ht(D,e,n,n.viewport)}}else r.length>0&&gt(n,r,e,t),Oe&&qe.render(e),ht(D,e,t)}N!==null&&ae===0&&(L.updateMultisampleRenderTarget(N),L.updateRenderTargetMipmap(N)),r&&re.end(j),e.isScene===!0&&e.onAfterRender(j,e,t),nt.resetDefaultState(),oe=-1,se=null,A.pop(),A.length>0?(O=A[A.length-1],Se===!0&&Ge.setGlobalState(j.clippingPlanes,O.state.camera)):O=null,ne.pop(),D=ne.length>0?ne[ne.length-1]:null};function mt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLight)O.pushLight(e),e.castShadow&&O.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||xe.intersectsSprite(e)){r&&Ee.setFromMatrixPosition(e.matrixWorld).applyMatrix4(we);let t=Le.update(e),i=e.material;i.visible&&D.push(e,t,i,n,Ee.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||xe.intersectsObject(e))){let t=Le.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),Ee.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Ee.copy(e.boundingSphere.center)),Ee.applyMatrix4(e.matrixWorld).applyMatrix4(we)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&D.push(e,t,s,n,Ee.z,o)}}else i.visible&&D.push(e,t,i,n,Ee.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)mt(i[e],t,n,r)}function ht(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;O.setupLightsView(n),Se===!0&&Ge.setGlobalState(j.clippingPlanes,n),r&&F.viewport(ce.copy(r)),i.length>0&&_t(i,t,n),a.length>0&&_t(a,t,n),o.length>0&&_t(o,t,n),F.buffers.depth.setTest(!0),F.buffers.depth.setMask(!0),F.buffers.color.setMask(!0),F.setPolygonOffset(!1)}function gt(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(O.state.transmissionRenderTarget[r.id]===void 0){let e=je.has(`EXT_color_buffer_half_float`)||je.has(`EXT_color_buffer_float`);O.state.transmissionRenderTarget[r.id]=new kt(1,1,{generateMipmaps:!0,type:e?g:l,minFilter:c,samples:Math.max(4,Me.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:G.workingColorSpace})}let a=O.state.transmissionRenderTarget[r.id],o=r.viewport||ce;a.setSize(o.z*j.transmissionResolutionScale,o.w*j.transmissionResolutionScale);let s=j.getRenderTarget(),u=j.getActiveCubeFace(),d=j.getActiveMipmapLevel();j.setRenderTarget(a),j.getClearColor(de),fe=j.getClearAlpha(),fe<1&&j.setClearColor(16777215,.5),j.clear(),Oe&&qe.render(n);let f=j.toneMapping;j.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),O.setupLightsView(r),Se===!0&&Ge.setGlobalState(j.clippingPlanes,r),_t(e,n,r),L.updateMultisampleRenderTarget(a),L.updateRenderTargetMipmap(a),je.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,vt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(L.updateMultisampleRenderTarget(a),L.updateRenderTargetMipmap(a))}j.setRenderTarget(s,u,d),j.setClearColor(de,fe),p!==void 0&&(r.viewport=p),j.toneMapping=f}function _t(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&vt(o,t,n,s,l,c)}}function vt(e,t,n,r,i,a){e.onBeforeRender(j,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(j,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,j.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,j.renderBufferDirect(n,t,r,i,e,a),i.side=2):j.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(j,t,n,r,i,a)}function yt(e,t,n){t.isScene!==!0&&(t=De);let r=I.get(e),i=O.state.lights,a=O.state.shadowsArray,o=i.state.version,s=Be.getParameters(e,i.state,a,t,n),c=Be.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Pe.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,ct),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return xt(e,s),d}else s.uniforms=Be.getUniforms(e),e.onBeforeCompile(s,j),d=Be.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Ge.uniform),xt(e,s),r.needsLights=wt(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.currentProgram=d,r.uniformsList=null,d}function bt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=Es.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function xt(e,t){let n=I.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function St(e,t,n,r,i){t.isScene!==!0&&(t=De),L.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=N===null?j.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:ze,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Pe.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(h=j.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=I.get(r),y=O.state.lights;if(Se===!0&&(Ce===!0||e!==se)){let t=e===se&&r.id===oe;Ge.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Ge.numPlanes||v.numIntersection!==Ge.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h?v.morphTargetsCount!==_&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=yt(r,t,i));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(F.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==oe&&(oe=r.id,C=!0),S||se!==e){F.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(P,`projectionMatrix`,e.projectionMatrix),T.setValue(P,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(P,Te.setFromMatrixPosition(e.matrixWorld)),Me.logarithmicDepthBuffer&&T.setValue(P,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(P,`isOrthographic`,e.isOrthographicCamera===!0),se!==e&&(se=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(P,`directionalShadowMap`,y.state.directionalShadowMap,L),y.state.spotShadowMap.length>0&&T.setValue(P,`spotShadowMap`,y.state.spotShadowMap,L),y.state.pointShadowMap.length>0&&T.setValue(P,`pointShadowMap`,y.state.pointShadowMap,L)),i.isSkinnedMesh){T.setOptional(P,i,`bindMatrix`),T.setOptional(P,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(P,`boneTexture`,e.boneTexture,L))}i.isBatchedMesh&&(T.setOptional(P,i,`batchingTexture`),T.setValue(P,`batchingTexture`,i._matricesTexture,L),T.setOptional(P,i,`batchingIdTexture`),T.setValue(P,`batchingIdTexture`,i._indirectTexture,L),T.setOptional(P,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(P,`batchingColorTexture`,i._colorsTexture,L));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&Ye.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(P,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=Kc()),C&&(T.setValue(P,`toneMappingExposure`,j.toneMappingExposure),v.needsLights&&Ct(E,w),a&&r.fog===!0&&Ve.refreshFogUniforms(E,a),Ve.refreshMaterialUniforms(E,r,he,me,O.state.transmissionRenderTarget[e.id]),Es.upload(P,bt(v),E,L)),r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(Es.upload(P,bt(v),E,L),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(P,`center`,i.center),T.setValue(P,`modelViewMatrix`,i.modelViewMatrix),T.setValue(P,`normalMatrix`,i.normalMatrix),T.setValue(P,`modelMatrix`,i.matrixWorld),r.isShaderMaterial||r.isRawShaderMaterial){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];rt.update(n,x),rt.bind(n,x)}}return x}function Ct(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function wt(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return ie},this.getActiveMipmapLevel=function(){return ae},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(e,t,n){let r=I.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),I.get(e.texture).__webglTexture=t,I.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=I.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0};let Tt=P.createFramebuffer();this.setRenderTarget=function(e,t=0,n=0){N=e,ie=t,ae=n;let r=null,i=!1,a=!1;if(e){let o=I.get(e);if(o.__useDefaultFramebuffer!==void 0){F.bindFramebuffer(P.FRAMEBUFFER,o.__webglFramebuffer),ce.copy(e.viewport),le.copy(e.scissor),ue=e.scissorTest,F.viewport(ce),F.scissor(le),F.setScissorTest(ue),oe=-1;return}else if(o.__webglFramebuffer===void 0)L.setupRenderTarget(e);else if(o.__hasExternalTextures)L.rebindTextures(e,I.get(e.texture).__webglTexture,I.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&I.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.`);L.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=I.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&L.useMultisampledRTT(e)===!1?I.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,ce.copy(e.viewport),le.copy(e.scissor),ue=e.scissorTest}else ce.copy(ve).multiplyScalar(he).floor(),le.copy(ye).multiplyScalar(he).floor(),ue=be;if(n!==0&&(r=Tt),F.bindFramebuffer(P.FRAMEBUFFER,r)&&F.drawBuffers(e,r),F.viewport(ce),F.scissor(le),F.setScissorTest(ue),i){let r=I.get(e.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=I.get(e.textures[t]);P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=I.get(e.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,t.__webglTexture,n)}oe=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){z(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=I.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){F.bindFramebuffer(P.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+s),!Me.textureFormatReadable(c)){z(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Me.textureTypeReadable(l)){z(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&P.readPixels(t,n,r,i,tt.convert(c),tt.convert(l),a)}finally{let e=N===null?null:I.get(N).__webglFramebuffer;F.bindFramebuffer(P.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=I.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){F.bindFramebuffer(P.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+s),!Me.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Me.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,d),P.bufferData(P.PIXEL_PACK_BUFFER,a.byteLength,P.STREAM_READ),P.readPixels(t,n,r,i,tt.convert(l),tt.convert(u),0);let f=N===null?null:I.get(N).__webglFramebuffer;F.bindFramebuffer(P.FRAMEBUFFER,f);let p=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await et(P,p,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,d),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,a),P.deleteBuffer(d),P.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;L.setTexture2D(e,0),P.copyTexSubImage2D(P.TEXTURE_2D,n,0,0,o,s,i,a),F.unbindTexture()};let Et=P.createFramebuffer(),Ot=P.createFramebuffer();this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=tt.convert(t.format),_=tt.convert(t.type),v;t.isData3DTexture?(L.setTexture3D(t,0),v=P.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(L.setTexture2DArray(t,0),v=P.TEXTURE_2D_ARRAY):(L.setTexture2D(t,0),v=P.TEXTURE_2D),P.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,t.flipY),P.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),P.pixelStorei(P.UNPACK_ALIGNMENT,t.unpackAlignment);let y=P.getParameter(P.UNPACK_ROW_LENGTH),b=P.getParameter(P.UNPACK_IMAGE_HEIGHT),x=P.getParameter(P.UNPACK_SKIP_PIXELS),S=P.getParameter(P.UNPACK_SKIP_ROWS),C=P.getParameter(P.UNPACK_SKIP_IMAGES);P.pixelStorei(P.UNPACK_ROW_LENGTH,h.width),P.pixelStorei(P.UNPACK_IMAGE_HEIGHT,h.height),P.pixelStorei(P.UNPACK_SKIP_PIXELS,l),P.pixelStorei(P.UNPACK_SKIP_ROWS,u),P.pixelStorei(P.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=I.get(e),r=I.get(t),h=I.get(n.__renderTarget),g=I.get(r.__renderTarget);F.bindFramebuffer(P.READ_FRAMEBUFFER,h.__webglFramebuffer),F.bindFramebuffer(P.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,I.get(e).__webglTexture,i,d+n),P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,I.get(t).__webglTexture,a,m+n)),P.blitFramebuffer(l,u,o,s,f,p,o,s,P.DEPTH_BUFFER_BIT,P.NEAREST);F.bindFramebuffer(P.READ_FRAMEBUFFER,null),F.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||I.has(e)){let n=I.get(e),r=I.get(t);F.bindFramebuffer(P.READ_FRAMEBUFFER,Et),F.bindFramebuffer(P.DRAW_FRAMEBUFFER,Ot);for(let e=0;e<c;e++)w?P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):P.framebufferTexture2D(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,n.__webglTexture,i),T?P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):P.framebufferTexture2D(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,r.__webglTexture,a),i===0?T?P.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):P.copyTexSubImage2D(v,a,f,p,l,u,o,s):P.blitFramebuffer(l,u,o,s,f,p,o,s,P.COLOR_BUFFER_BIT,P.NEAREST);F.bindFramebuffer(P.READ_FRAMEBUFFER,null),F.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?P.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?P.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):P.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):P.texSubImage2D(P.TEXTURE_2D,a,f,p,o,s,g,_,h);P.pixelStorei(P.UNPACK_ROW_LENGTH,y),P.pixelStorei(P.UNPACK_IMAGE_HEIGHT,b),P.pixelStorei(P.UNPACK_SKIP_PIXELS,x),P.pixelStorei(P.UNPACK_SKIP_ROWS,S),P.pixelStorei(P.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&P.generateMipmap(v),F.unbindTexture()},this.initRenderTarget=function(e){I.get(e).__webglFramebuffer===void 0&&L.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?L.setTextureCube(e,0):e.isData3DTexture?L.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?L.setTexture2DArray(e,0):L.setTexture2D(e,0),F.unbindTexture()},this.resetState=function(){ie=0,ae=0,N=null,F.reset(),nt.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return We}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=G._getDrawingBufferColorSpace(e),t.unpackColorSpace=G._getUnpackColorSpace()}},Jc=class{fixedStep=1/60;accumulator=0;lastTime=0;running=!1;rafId=0;updateFn;renderFn;constructor(e,t){this.updateFn=e,this.renderFn=t}start(){this.running=!0,this.lastTime=performance.now(),this.accumulator=0,this.rafId=requestAnimationFrame(e=>this.tick(e))}stop(){this.running=!1,cancelAnimationFrame(this.rafId)}tick(e){if(!this.running)return;let t=Math.min((e-this.lastTime)/1e3,.1);for(this.lastTime=e,this.accumulator+=t;this.accumulator>=this.fixedStep;)this.updateFn(this.fixedStep),this.accumulator-=this.fixedStep;let n=this.accumulator/this.fixedStep;this.renderFn(n),this.rafId=requestAnimationFrame(e=>this.tick(e))}},Yc=class{keys=new Set;moveVector={x:0,z:0};touchActive=!1;touchStartX=0;touchStartY=0;joystickSensitivity=.01;constructor(){window.addEventListener(`keydown`,e=>this.keys.add(e.key.toLowerCase())),window.addEventListener(`keyup`,e=>this.keys.delete(e.key.toLowerCase())),window.addEventListener(`pointerdown`,e=>this.onPointerDown(e)),window.addEventListener(`pointermove`,e=>this.onPointerMove(e)),window.addEventListener(`pointerup`,()=>this.onPointerUp()),window.addEventListener(`pointercancel`,()=>this.onPointerUp())}onPointerDown(e){(e.clientX<window.innerWidth*.6||e.pointerType===`touch`)&&(this.touchActive=!0,this.touchStartX=e.clientX,this.touchStartY=e.clientY)}onPointerMove(e){if(!this.touchActive)return;let t=(e.clientX-this.touchStartX)*this.joystickSensitivity,n=(e.clientY-this.touchStartY)*this.joystickSensitivity,r=Math.sqrt(t*t+n*n);r>1?(this.moveVector.x=t/r*1,this.moveVector.z=n/r*1):r>.1?(this.moveVector.x=t,this.moveVector.z=n):(this.moveVector.x=0,this.moveVector.z=0)}onPointerUp(){this.touchActive=!1,this.moveVector.x=0,this.moveVector.z=0}getMovement(){let e=0,t=0;if((this.keys.has(`w`)||this.keys.has(`arrowup`))&&(t=-1),(this.keys.has(`s`)||this.keys.has(`arrowdown`))&&(t=1),(this.keys.has(`a`)||this.keys.has(`arrowleft`))&&(e=-1),(this.keys.has(`d`)||this.keys.has(`arrowright`))&&(e=1),e!==0&&t!==0){let n=1/Math.SQRT2;e*=n,t*=n}return this.touchActive?{x:this.moveVector.x,z:this.moveVector.z}:{x:e,z:t}}};function Xc(e){let t=new qc({antialias:!0,powerPreference:`high-performance`});return t.setSize(window.innerWidth,window.innerHeight),t.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.shadowMap.enabled=!1,t.setClearColor(9357544),e.insertBefore(t.domElement,e.firstChild),window.addEventListener(`resize`,()=>{t.setSize(window.innerWidth,window.innerHeight)}),t}function Zc(){let e=new la(50,window.innerWidth/window.innerHeight,.1,500);return e.position.set(0,25,20),e.lookAt(0,0,0),window.addEventListener(`resize`,()=>{e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix()}),e}function Qc(){let e=new gn;e.fog=new hn(9357544,100,250);let t=new pa(16775393,.6);e.add(t);let n=new fa(16774112,.9);n.position.set(50,80,30),e.add(n);let r=new Zi(8900331,4881497,.3);return e.add(r),e}var $c=class{group;holeSurface;holeInterior;rim;innerRim;currentRadius=1.5;constructor(e=1710638){this.group=new sn,this.holeSurface=new q(new hi(1,64),new Br({color:328965,depthWrite:!0})),this.holeSurface.rotation.x=-Math.PI/2,this.holeSurface.position.y=.03,this.holeSurface.renderOrder=1,this.group.add(this.holeSurface),this.holeInterior=new q(new bi(1,32,16,0,Math.PI*2,0,Math.PI/2),new ji({color:657930,roughness:1,metalness:0,side:1})),this.holeInterior.rotation.x=Math.PI,this.holeInterior.position.y=-.05,this.holeInterior.renderOrder=0,this.group.add(this.holeInterior),this.rim=new q(new yi(.92,1,64),new Br({color:e,side:2})),this.rim.rotation.x=-Math.PI/2,this.rim.position.y=.04,this.rim.renderOrder=2,this.group.add(this.rim),this.innerRim=new q(new yi(.7,.95,64),new Br({color:1118498,transparent:!0,opacity:.5,side:2})),this.innerRim.rotation.x=-Math.PI/2,this.innerRim.position.y=.035,this.innerRim.renderOrder=1,this.group.add(this.innerRim),this.setRadius(this.currentRadius)}setRadius(e){this.currentRadius=e,this.holeSurface.scale.set(e,e,1),this.holeInterior.scale.set(e,e*.5,e),this.rim.scale.set(e,e,1),this.innerRim.scale.set(e,e,1)}getRadius(){return this.currentRadius}setPosition(e,t){this.group.position.set(e,0,t)}static createGround(e){let t=new q(new vi(e,e),new ji({color:5929554,roughness:.9}));return t.rotation.x=-Math.PI/2,t.position.y=0,t.renderOrder=0,t}},Z={XS:0,S:1,M:2,L:3,XL:4},el=[`XS`,`S`,`M`,`L`,`XL`],tl={[Z.XS]:1,[Z.S]:2,[Z.M]:4,[Z.L]:7,[Z.XL]:12};Z.XS,Z.S,Z.M,Z.L,Z.XL,Z.XS,Z.S,Z.M,Z.L,Z.XL;function nl(e){return e>=tl[Z.XL]?Z.XL:e>=tl[Z.L]?Z.L:e>=tl[Z.M]?Z.M:e>=tl[Z.S]?Z.S:Z.XS}function rl(e,t){return e>=tl[t]}var Q={rickshawGreen:3046706,rickshawBlack:2171169,rickshawYellow:16761095,bmtcRed:12986408,bmtcBlue:1402304,buildingWhite:15527921,buildingGray:7901340,buildingBrown:9268835,treeTrunk:6111287,treeGreen:3706428,treeDarkGreen:1793568,coneOrange:16739584,personSkin:16764032,personClothes:[15277667,2201331,5025616,16750592,10233776],cartWood:9268835,cartRed:15684432,vidhanaGray:9479342,vidhanaDome:7901340,palaceYellow:16766287,iskconWhite:16448250,iskconGold:16761095,lampPostGray:6381921,lampYellow:16772696,itParkBlue:4367861,itParkGlass:12312315};function $(e){return new ji({color:e,flatShading:!0,roughness:.8})}function il(){let e=new sn,t=new q(new _i(.15,.5,6),$(Q.coneOrange));t.position.y=.25,e.add(t);let n=new q(new J(.35,.05,.35),$(3355443));return n.position.y=.025,e.add(n),{mesh:e,tier:Z.XS,points:10,volume:1,name:`Traffic Cone`}}function al(){let e=new sn,t=new q(new gi(.15,.2,.25,6),$(Q.cartRed));t.position.y=.125,e.add(t);let n=new q(new bi(.25,6,4),$(Q.treeGreen));return n.position.y=.45,e.add(n),{mesh:e,tier:Z.XS,points:10,volume:1,name:`Plant`}}function ol(){let e=new sn,t=new q(new J(.8,.5,.5),$(Q.cartWood));t.position.y=.45,e.add(t);for(let t of[-.3,.3]){let n=new q(new gi(.12,.12,.05,8),$(3355443));n.rotation.z=Math.PI/2,n.position.set(t,.12,.28),e.add(n)}let n=new q(new _i(.5,.3,8),$(Q.cartRed));return n.position.y=1,e.add(n),{mesh:e,tier:Z.XS,points:15,volume:2,name:`Food Cart`}}function sl(){let e=new sn,t=new q(new gi(.04,.05,1.5,6),$(Q.lampPostGray));t.position.y=.75,e.add(t);let n=new q(new bi(.12,6,4),$(Q.lampYellow));return n.position.y=1.55,e.add(n),{mesh:e,tier:Z.XS,points:10,volume:1,name:`Lamp Post`}}function cl(){let e=new sn,t=Q.personClothes[Math.floor(Math.random()*Q.personClothes.length)],n=new q(new mi(.15,.5,4,6),$(t));n.position.y=.6,e.add(n);let r=new q(new bi(.12,6,4),$(Q.personSkin));return r.position.y=1.05,e.add(r),{mesh:e,tier:Z.S,points:25,volume:3,name:`Person`}}function ll(){let e=new sn,t=new q(new gi(.08,.12,1,6),$(Q.treeTrunk));t.position.y=.5,e.add(t);let n=new q(new _i(.6,1.2,6),$(Q.treeGreen));return n.position.y=1.5,e.add(n),{mesh:e,tier:Z.S,points:20,volume:4,name:`Tree`}}function ul(){let e=new sn,t=new q(new J(.8,.06,.3),$(Q.cartWood));t.position.y=.35,e.add(t);for(let t of[-.35,.35]){let n=new q(new J(.05,.35,.25),$(4342338));n.position.set(t,.175,0),e.add(n)}let n=new q(new J(.8,.4,.04),$(Q.cartWood));return n.position.set(0,.55,-.13),e.add(n),{mesh:e,tier:Z.S,points:20,volume:3,name:`Bench`}}function dl(){let e=new sn,t=new q(new J(.9,.7,.7),$(Q.rickshawGreen));t.position.y=.55,e.add(t);let n=new q(new J(.85,.08,.65),$(Q.rickshawBlack));n.position.y=.95,e.add(n);let r=new q(new J(.3,.5,.5),$(Q.rickshawGreen));r.position.set(.55,.45,0),e.add(r);let i=new q(new bi(.06,6,4),$(Q.rickshawYellow));i.position.set(.7,.5,0),e.add(i);let a=$(2171169),o=new gi(.12,.12,.08,8),s=new q(o,a);s.rotation.z=Math.PI/2,s.position.set(.55,.12,0),e.add(s);for(let t of[-.35,.35]){let n=new q(o,a);n.rotation.z=Math.PI/2,n.position.set(-.2,.12,t),e.add(n)}return{mesh:e,tier:Z.M,points:50,volume:12,name:`Auto Rickshaw`}}function fl(){let e=new sn,t=[1402304,12986408,16119285,4342338,16748288],n=t[Math.floor(Math.random()*t.length)],r=new q(new J(1.6,.5,.8),$(n));r.position.y=.4,e.add(r);let i=new q(new J(.9,.4,.75),$(12312315));i.position.set(-.1,.8,0),e.add(i);let a=$(2171169),o=new gi(.15,.15,.08,8);for(let t of[-.5,.5])for(let n of[-.4,.4]){let r=new q(o,a);r.rotation.x=Math.PI/2,r.position.set(t,.15,n),e.add(r)}return{mesh:e,tier:Z.M,points:40,volume:15,name:`Car`}}function pl(){let e=new sn,t=new q(new J(3.5,1.2,1.2),$(Q.bmtcRed));t.position.y=1,e.add(t);let n=new q(new J(3.52,.25,1.22),$(Q.bmtcBlue));n.position.y=.6,e.add(n);let r=$(12312315),i=new J(.3,.35,1.22);for(let t=-1.2;t<=1.2;t+=.5){let n=new q(i,r);n.position.set(t,1.2,0),e.add(n)}let a=$(2171169),o=new gi(.25,.25,.1,8);for(let t of[-1.2,1.2])for(let n of[-.6,.6]){let r=new q(o,a);r.rotation.x=Math.PI/2,r.position.set(t,.25,n),e.add(r)}return{mesh:e,tier:Z.L,points:100,volume:50,name:`BMTC Bus`}}function ml(){let e=new sn,t=2+Math.random()*3,n=[Q.buildingWhite,Q.buildingGray,Q.buildingBrown,16769202,13166281],r=n[Math.floor(Math.random()*n.length)],i=new q(new J(2,t,2),$(r));i.position.y=t/2,e.add(i);let a=$(9489145);for(let n=.8;n<t-.3;n+=.8)for(let t of[-.6,0,.6]){let r=new q(new J(.01,.35,.25),a);r.position.set(1.01,n,t),e.add(r);let i=r.clone();i.position.set(-1.01,n,t),e.add(i)}return{mesh:e,tier:Z.L,points:80,volume:40,name:`Building`}}function hl(){let e=new sn,t=new q(new J(8,3,5),$(Q.vidhanaGray));t.position.y=1.5,e.add(t);let n=new q(new J(6,1.5,4),$(Q.vidhanaGray));n.position.y=3.75,e.add(n);let r=new q(new bi(1.2,8,6,0,Math.PI*2,0,Math.PI/2),$(Q.vidhanaDome));r.position.y=4.5,e.add(r);let i=$(11583173);for(let t=-3;t<=3;t+=1){let n=new q(new gi(.15,.15,3,6),i);n.position.set(t,1.5,2.55),e.add(n)}let a=new q(new J(8.5,.4,2),$(13621468));return a.position.set(0,.2,3.5),e.add(a),{mesh:e,tier:Z.XL,points:500,volume:200,name:`Vidhana Soudha`}}function gl(){let e=new sn,t=new q(new J(6,3,4),$(Q.palaceYellow));t.position.y=1.5,e.add(t);let n=$(16761095);for(let t of[-2.8,2.8])for(let r of[-1.8,1.8]){let i=new q(new gi(.5,.5,4.5,6),n);i.position.set(t,2.25,r),e.add(i);let a=new q(new _i(.6,1,6),$(13840175));a.position.set(t,5,r),e.add(a)}let r=new q(new gi(.6,.6,5.5,8),n);r.position.y=2.75,e.add(r);let i=new q(new _i(.7,1.2,8),$(13840175));return i.position.y=6.1,e.add(i),{mesh:e,tier:Z.XL,points:500,volume:200,name:`Bangalore Palace`}}function _l(){let e=new sn,t=new q(new J(5,.5,5),$(Q.iskconWhite));t.position.y=.25,e.add(t);let n=new q(new J(4,3,4),$(Q.iskconWhite));n.position.y=2,e.add(n);let r=new q(new _i(1.2,4,8),$(Q.iskconGold));r.position.y=5.5,e.add(r);for(let t of[-1.5,1.5]){let n=new q(new _i(.6,2.5,6),$(Q.iskconGold));n.position.set(t,4.75,0),e.add(n)}let i=new q(new bi(.3,8,6),$(Q.iskconGold));return i.position.y=7.7,e.add(i),{mesh:e,tier:Z.XL,points:500,volume:200,name:`ISKCON Temple`}}function vl(){let e=new sn,t=5+Math.random()*3,n=new q(new J(3,t,3),$(Q.itParkGlass));n.position.y=t/2,e.add(n);let r=$(Q.itParkBlue);for(let n=.5;n<t;n+=1){let t=new q(new J(3.02,.04,3.02),r);t.position.y=n,e.add(t)}return{mesh:e,tier:Z.L,points:120,volume:60,name:`IT Park`}}function yl(){let e=new sn,t=new q(new gi(.3,.5,2,8),$(Q.treeTrunk));t.position.y=1,e.add(t);let n=new q(new bi(1.8,8,6),$(Q.treeDarkGreen));n.position.y=2.8,n.scale.set(1,.6,1),e.add(n);for(let t=0;t<4;t++){let n=t/4*Math.PI*2,r=new q(new gi(.03,.03,1.5,4),$(Q.treeTrunk));r.position.set(Math.cos(n)*1,1.2,Math.sin(n)*1),e.add(r)}return{mesh:e,tier:Z.M,points:35,volume:10,name:`Banyan Tree`}}function bl(){let e=new sn,t=new q(new J(6,.4,4),$(13621468));t.position.y=.2,e.add(t);let n=new ji({color:11789820,transparent:!0,opacity:.4,flatShading:!0,roughness:.1,metalness:.3}),r=new q(new J(5.5,2,3.5),n);r.position.y=1.4,e.add(r);let i=new q(new gi(2,2,5.5,12,1,!1,0,Math.PI),n);i.rotation.z=Math.PI/2,i.rotation.y=Math.PI/2,i.position.y=2.4,e.add(i);let a=$(5533306);for(let t=-2;t<=2;t+=1){let n=new q(new xi(1.8,.04,4,12,Math.PI),a);n.position.set(t,2.4,0),e.add(n)}return{mesh:e,tier:Z.XL,points:500,volume:200,name:`Lalbagh Glasshouse`}}function xl(){let e=new sn,t=new q(new J(1.5,1.2,1.2),$(5125166));t.position.y=.6,e.add(t);let n=new q(new J(1,.3,.05),$(16763906));n.position.set(0,1.4,.63),e.add(n);let r=new q(new J(1.7,.05,.6),$(13840175));r.position.set(0,1.15,.9),r.rotation.x=.15,e.add(r);let i=new q(new gi(.15,.15,.4,6),$(9268835));return i.position.set(.5,.2,1),e.add(i),{mesh:e,tier:Z.S,points:30,volume:5,name:`Coffee Shop`}}function Sl(){let e=new sn,t=new q(new J(.7,.3,.25),$(2171169));t.position.y=.35,e.add(t);let n=new q(new J(.3,.08,.2),$(4342338));n.position.set(-.1,.55,0),e.add(n);let r=new q(new gi(.02,.02,.4,4),$(7697781));r.position.set(.3,.35,0),r.rotation.z=.3,e.add(r);let i=$(3355443);for(let t of[-.25,.3]){let n=new q(new xi(.12,.03,6,12),i);n.position.set(t,.15,0),e.add(n)}let a=new q(new bi(.04,6,4),$(16772696));return a.position.set(.38,.5,0),e.add(a),{mesh:e,tier:Z.S,points:30,volume:4,name:`Motorcycle`}}function Cl(){let e=new sn,t=new q(new gi(.4,.5,4,8),$(7901340));t.position.y=2,e.add(t);let n=new q(new J(3,.5,1.5),$(9479342));n.position.y=4.25,e.add(n);let r=new q(new J(3.02,.15,1.52),$(8069026));return r.position.y=4.05,e.add(r),{mesh:e,tier:Z.L,points:90,volume:45,name:`Metro Pillar`}}function wl(e,t,n){return e+(t-e)*n}function Tl(e,t,n){return Math.max(t,Math.min(n,e))}function El(e,t,n,r){let i=n-e,a=r-t;return Math.sqrt(i*i+a*a)}function Dl(e,t){return e+Math.random()*(t-e)}var Ol=160/2,kl=[{name:`MG Road`,x:0,z:0,w:20,h:12,type:`commercial`,density:.9,color:4545124},{name:`Brigade Road`,x:-8,z:-10,w:12,h:10,type:`market`,density:.9,color:5533306},{name:`Majestic`,x:-20,z:-15,w:18,h:14,type:`commercial`,density:.8,color:5125166},{name:`Malleshwaram`,x:-35,z:-40,w:22,h:18,type:`old_city`,density:.7,color:6111287},{name:`Sadashivanagar`,x:-5,z:-42,w:18,h:14,type:`residential`,density:.5,color:3369246},{name:`Cantonment`,x:25,z:-35,w:20,h:16,type:`old_city`,density:.6,color:5125166},{name:`Indiranagar`,x:35,z:0,w:22,h:16,type:`commercial`,density:.8,color:3622735},{name:`Whitefield`,x:60,z:5,w:20,h:20,type:`it_hub`,density:.7,color:2503224},{name:`Koramangala`,x:15,z:20,w:22,h:16,type:`commercial`,density:.8,color:3622735},{name:`Jayanagar`,x:-15,z:35,w:22,h:18,type:`residential`,density:.6,color:3046706},{name:`BTM Layout`,x:15,z:38,w:18,h:14,type:`residential`,density:.7,color:3369246},{name:`HSR Layout`,x:40,z:40,w:18,h:16,type:`it_hub`,density:.6,color:2503224},{name:`Basavanagudi`,x:-25,z:18,w:18,h:14,type:`old_city`,density:.6,color:6111287},{name:`Rajajinagar`,x:-45,z:-10,w:18,h:16,type:`residential`,density:.5,color:3369246},{name:`Vijayanagar`,x:-50,z:10,w:16,h:14,type:`residential`,density:.5,color:3369246},{name:`Cubbon Park`,x:5,z:-22,w:20,h:14,type:`park`,density:.3,color:1793568},{name:`Lalbagh`,x:-10,z:15,w:18,h:16,type:`park`,density:.3,color:1793568}],Al=[{x1:-Ol,z1:0,x2:Ol,z2:0,width:5,name:`MG Road`},{x1:-Ol,z1:-15,x2:Ol,z2:-15,width:4,name:`Seshadri Road`},{x1:-Ol,z1:20,x2:Ol,z2:20,width:4,name:`Hosur Road`},{x1:-40,z1:-35,x2:50,z2:-35,width:3,name:`Bellary Road`},{x1:-40,z1:38,x2:50,z2:38,width:3,name:`Bannerghatta Road`},{x1:-Ol,z1:-8,x2:-10,z2:-8,width:3,name:`Chord Road`},{x1:0,z1:-Ol,x2:0,z2:Ol,width:5,name:`Namma Metro (Purple)`},{x1:-20,z1:-Ol,x2:-20,z2:Ol,width:4,name:`Tumkur Road`},{x1:25,z1:-Ol,x2:25,z2:Ol,width:4,name:`100 Feet Road`},{x1:-40,z1:-50,x2:-40,z2:30,width:3,name:`Bull Temple Road`},{x1:50,z1:-40,x2:50,z2:50,width:3,name:`Old Airport Road`},{x1:-10,z1:-10,x2:-10,z2:30,width:2.5,name:`DVG Road`},{x1:15,z1:5,x2:15,z2:45,width:2.5,name:`Sarjapur Road`},{x1:35,z1:-20,x2:35,z2:20,width:2.5,name:`CMH Road`},{x1:-30,z1:-30,x2:-30,z2:0,width:2.5,name:`Sampige Road`}];function jl(e){let t=new ji({color:2894892,roughness:.95});for(let n of Al){let r=n.x2-n.x1,i=n.z2-n.z1,a=Math.sqrt(r*r+i*i),o=new q(Math.abs(r)>Math.abs(i)?new vi(a,n.width):new vi(n.width,a),t);o.rotation.x=-Math.PI/2,o.position.set((n.x1+n.x2)/2,.01,(n.z1+n.z2)/2),o.renderOrder=1,e.add(o)}let n=new Br({color:16771899});for(let t of Al){let r=t.x2-t.x1,i=t.z2-t.z1,a=Math.sqrt(r*r+i*i),o=Math.abs(r)>Math.abs(i),s=Math.floor(a/4);for(let a=0;a<s;a+=2){let c=(a+.5)/s,l=new q(new vi(o?2:.12,o?.12:2),n);l.rotation.x=-Math.PI/2,l.position.set(t.x1+r*c,.02,t.z1+i*c),l.renderOrder=1,e.add(l)}}}function Ml(e,t,n=2){for(let r of Al)if(Math.abs(r.x2-r.x1)>Math.abs(r.z2-r.z1)){let i=Math.min(r.x1,r.x2),a=Math.max(r.x1,r.x2);if(e>=i&&e<=a&&Math.abs(t-r.z1)<r.width/2+n)return!0}else{let i=Math.min(r.z1,r.z2),a=Math.max(r.z1,r.z2);if(t>=i&&t<=a&&Math.abs(e-r.x1)<r.width/2+n)return!0}return!1}function Nl(e,t,n=5){return Ml(e,t,n)}function Pl(e){for(let t of kl){let n=new ji({color:t.type===`park`?2976304:t.color,roughness:.92}),r=new q(new vi(t.w,t.h),n);if(r.rotation.x=-Math.PI/2,r.position.set(t.x,.005,t.z),r.renderOrder=0,e.add(r),t.type===`park`){let n=new ji({color:1793568,flatShading:!0}),r=[{sx:t.w,sz:.3,px:t.x,pz:t.z-t.h/2},{sx:t.w,sz:.3,px:t.x,pz:t.z+t.h/2},{sx:.3,sz:t.h,px:t.x-t.w/2,pz:t.z},{sx:.3,sz:t.h,px:t.x+t.w/2,pz:t.z}];for(let t of r){let r=new q(new J(t.sx,.3,t.sz),n);r.position.set(t.px,.15,t.pz),e.add(r)}}}}function Fl(e){let t=document.createElement(`canvas`),n=t.getContext(`2d`);t.width=256,t.height=64;for(let r of kl){n.clearRect(0,0,256,64),n.fillStyle=r.type===`park`?`#a5d6a7`:`#b0bec5`,n.font=`bold 28px system-ui, sans-serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(r.name,128,32);let i=new ui(t);i.needsUpdate=!0;let a=new gr({map:i.clone(),transparent:!0,opacity:.7,depthTest:!1});a.map.needsUpdate=!0;let o=new Ar(a);o.position.set(r.x,6,r.z),o.scale.set(10,2.5,1),o.renderOrder=10,e.add(o)}}function Il(e,t,n,r,i=()=>!0){let a=0,o=0;for(;a<r&&o<r*8;){o++;let r=Dl(-Ol+5,Ol-5),s=Dl(-Ol+5,Ol-5);if(!i(r,s)||t.some(e=>Math.abs(e.x-r)<1.5&&Math.abs(e.z-s)<1.5))continue;let c=n();c.mesh.position.set(r,0,s),c.mesh.rotation.y=Math.random()*Math.PI*2,e.add(c.mesh),t.push({...c,x:r,z:s,consumed:!1,consuming:!1,consumeProgress:0,originalY:0,originalScale:1,holeX:0,holeZ:0}),a++}}function Ll(e,t,n,r,i,a=()=>!0){let o=0,s=0;for(;o<r&&s<r*10;){s++;let r=Dl(i.x-i.w/2+1,i.x+i.w/2-1),c=Dl(i.z-i.h/2+1,i.z+i.h/2-1);if(!a(r,c)||t.some(e=>Math.abs(e.x-r)<1.2&&Math.abs(e.z-c)<1.2))continue;let l=n();l.mesh.position.set(r,0,c),l.mesh.rotation.y=Math.random()*Math.PI*2,e.add(l.mesh),t.push({...l,x:r,z:c,consumed:!1,consuming:!1,consumeProgress:0,originalY:0,originalScale:1,holeX:0,holeZ:0}),o++}}function Rl(e){let t=[];Pl(e),Fl(e),Il(e,t,il,50,(e,t)=>Nl(e,t,4)),Il(e,t,sl,40,(e,t)=>Nl(e,t,4)),Il(e,t,cl,60,(e,t)=>!Ml(e,t,0)),Il(e,t,Sl,30,(e,t)=>Nl(e,t,5)),Il(e,t,dl,40,(e,t)=>Nl(e,t,5)),Il(e,t,fl,25,(e,t)=>Nl(e,t,4)),Il(e,t,pl,12,(e,t)=>Nl(e,t,5)),Il(e,t,al,40),Il(e,t,ll,30,(e,t)=>!Ml(e,t,1));for(let n of kl){let r=(e,t)=>!Ml(e,t,1),i=(e,t)=>Nl(e,t,5);switch(n.type){case`commercial`:case`market`:Ll(e,t,ml,Math.floor(8*n.density),n,r),Ll(e,t,xl,Math.floor(5*n.density),n,r),Ll(e,t,ol,Math.floor(6*n.density),n,i),Ll(e,t,cl,Math.floor(8*n.density),n,r),Ll(e,t,ul,Math.floor(3*n.density),n,r);break;case`residential`:Ll(e,t,ml,Math.floor(6*n.density),n,r),Ll(e,t,ll,Math.floor(5*n.density),n,r),Ll(e,t,al,Math.floor(4*n.density),n),Ll(e,t,cl,Math.floor(4*n.density),n,r);break;case`it_hub`:Ll(e,t,vl,Math.floor(4*n.density),n,r),Ll(e,t,ml,Math.floor(3*n.density),n,r),Ll(e,t,fl,Math.floor(5*n.density),n,i),Ll(e,t,cl,Math.floor(4*n.density),n,r);break;case`old_city`:Ll(e,t,ml,Math.floor(5*n.density),n,r),Ll(e,t,xl,Math.floor(4*n.density),n,r),Ll(e,t,ol,Math.floor(5*n.density),n,i),Ll(e,t,yl,Math.floor(3*n.density),n,r),Ll(e,t,dl,Math.floor(4*n.density),n,i),Ll(e,t,cl,Math.floor(6*n.density),n,r);break;case`park`:Ll(e,t,ll,Math.floor(10*n.density),n),Ll(e,t,yl,Math.floor(5*n.density),n),Ll(e,t,ul,Math.floor(6*n.density),n),Ll(e,t,cl,Math.floor(8*n.density),n),Ll(e,t,al,Math.floor(6*n.density),n);break}}for(let n=-Ol+10;n<Ol-10;n+=12)Ml(0,n,0)&&Il(e,t,Cl,1,(e,t)=>Math.abs(e)<3&&Math.abs(t-n)<3);let n=[{factory:hl,x:-10,z:-18},{factory:gl,x:-30,z:-35},{factory:_l,x:25,z:-30},{factory:bl,x:-10,z:15}];for(let r of n){let n=r.factory();n.mesh.position.set(r.x,0,r.z),e.add(n.mesh),t.push({...n,x:r.x,z:r.z,consumed:!1,consuming:!1,consumeProgress:0,originalY:0,originalScale:1,holeX:0,holeZ:0})}return t}var zl=100,Bl=class{particles=[];pool=[];scene;constructor(e){this.scene=e;let t=new bi(.08,4,3),n=new Br({color:12364452,transparent:!0});for(let r=0;r<zl;r++){let r=new q(t,n.clone());r.visible=!1,e.add(r),this.pool.push(r)}}burst(e,t,n,r=8,i=12364452){for(let a=0;a<r;a++){let o=this.pool.pop();if(!o)return;o.visible=!0,o.position.set(e,t+.2,n),o.material.color.setHex(i),o.material.opacity=1;let s=a/r*Math.PI*2+Math.random()*.5,c=2+Math.random()*3,l=2+Math.random()*3;this.particles.push({mesh:o,velocity:new U(Math.cos(s)*c,l,Math.sin(s)*c),life:0,maxLife:.4+Math.random()*.3})}}update(e){for(let t=this.particles.length-1;t>=0;t--){let n=this.particles[t];if(n.life+=e,n.life>=n.maxLife){n.mesh.visible=!1,this.pool.push(n.mesh),this.particles.splice(t,1);continue}let r=n.life/n.maxLife;n.mesh.position.x+=n.velocity.x*e,n.mesh.position.y+=n.velocity.y*e,n.mesh.position.z+=n.velocity.z*e,n.velocity.y-=10*e,n.mesh.material.opacity=1-r;let i=1-r*.5;n.mesh.scale.set(i,i,i)}}dispose(){for(let e of this.particles)this.scene.remove(e.mesh);for(let e of this.pool)this.scene.remove(e);this.particles=[],this.pool=[]}},Vl=class{ctx=null;enabled=!0;ensureContext(){return this.ctx||=new AudioContext,this.ctx.state===`suspended`&&this.ctx.resume(),this.ctx}playEat(e=0){if(!this.enabled)return;let t=this.ensureContext(),n=t.currentTime,r=300-e*40,i=t.createOscillator();i.type=`sine`,i.frequency.setValueAtTime(r,n),i.frequency.exponentialRampToValueAtTime(r*.3,n+.15);let a=t.createGain();a.gain.setValueAtTime(.3,n),a.gain.exponentialRampToValueAtTime(.01,n+.2),i.connect(a),a.connect(t.destination),i.start(n),i.stop(n+.2)}playBigEat(){if(!this.enabled)return;let e=this.ensureContext(),t=e.currentTime,n=e.createOscillator();n.type=`sawtooth`,n.frequency.setValueAtTime(150,t),n.frequency.exponentialRampToValueAtTime(40,t+.4);let r=e.createGain();r.gain.setValueAtTime(.25,t),r.gain.exponentialRampToValueAtTime(.01,t+.4);let i=e.createWaveShaper(),a=new Float32Array(256);for(let e=0;e<256;e++){let t=e*2/256-1;a[e]=Math.tanh(t*3)}i.curve=a,n.connect(i),i.connect(r),r.connect(e.destination),n.start(t),n.stop(t+.4)}playTierUp(){if(!this.enabled)return;let e=this.ensureContext(),t=e.currentTime;[400,500,600,800].forEach((n,r)=>{let i=e.createOscillator();i.type=`sine`,i.frequency.value=n;let a=e.createGain(),o=t+r*.08;a.gain.setValueAtTime(0,o),a.gain.linearRampToValueAtTime(.15,o+.02),a.gain.exponentialRampToValueAtTime(.01,o+.15),i.connect(a),a.connect(e.destination),i.start(o),i.stop(o+.15)})}playGameOver(){if(!this.enabled)return;let e=this.ensureContext(),t=e.currentTime,n=e.createOscillator();n.type=`triangle`,n.frequency.setValueAtTime(400,t),n.frequency.linearRampToValueAtTime(200,t+.5);let r=e.createGain();r.gain.setValueAtTime(.2,t),r.gain.linearRampToValueAtTime(0,t+.6),n.connect(r),r.connect(e.destination),n.start(t),n.stop(t+.6)}playDeath(){if(!this.enabled)return;let e=this.ensureContext(),t=e.currentTime,n=e.createOscillator();n.type=`sawtooth`,n.frequency.setValueAtTime(500,t),n.frequency.exponentialRampToValueAtTime(50,t+.5);let r=e.createGain();r.gain.setValueAtTime(.15,t),r.gain.exponentialRampToValueAtTime(.01,t+.5),n.connect(r),r.connect(e.destination),n.start(t),n.stop(t+.5)}toggle(){return this.enabled=!this.enabled,this.enabled}},Hl=[`MG Road Muncher`,`Koramangala Crusher`,`Indiranagar Eater`,`Whitefield Gobbler`,`Jayanagar Chomper`],Ul=[`#e91e63`,`#ff9800`,`#9c27b0`,`#00bcd4`,`#8bc34a`],Wl=120,Gl=2,Kl=50,ql=160/2;new class{renderer;camera;scene;loop;input;playerHole;playerX=0;playerZ=0;playerRadius=Gl;totalVolume=0;score=0;speed=15;aiHoles=[];objects=[];particles;audio=new Vl;lastTier=0;timer=Wl;gameState=`menu`;timerEl;scoreEl;sizeEl;hudEl;leaderboardEl;menuEl;gameOverEl;finalScoreEl;finalRankEl;sizeUpEl;minimapCanvas;minimapCtx;minimapEl;soundBtn;async init(){this.renderer=Xc(document.getElementById(`game-container`)),this.camera=Zc(),this.scene=Qc(),this.input=new Yc,this.timerEl=document.getElementById(`timer`),this.scoreEl=document.getElementById(`score`),this.sizeEl=document.getElementById(`size-label`),this.hudEl=document.getElementById(`hud`),this.leaderboardEl=document.getElementById(`leaderboard`),this.menuEl=document.getElementById(`main-menu`),this.gameOverEl=document.getElementById(`game-over`),this.finalScoreEl=document.getElementById(`final-score`),this.finalRankEl=document.getElementById(`final-rank`),this.sizeUpEl=document.getElementById(`size-up`),this.minimapCanvas=document.getElementById(`minimap-canvas`),this.minimapCtx=this.minimapCanvas.getContext(`2d`),this.minimapEl=document.getElementById(`minimap`),this.soundBtn=document.getElementById(`sound-btn`),document.getElementById(`play-btn`).addEventListener(`click`,()=>this.startGame()),document.getElementById(`restart-btn`).addEventListener(`click`,()=>this.startGame()),this.soundBtn.addEventListener(`click`,()=>{let e=this.audio.toggle();this.soundBtn.textContent=e?`🔊`:`🔇`}),this.loop=new Jc(e=>this.update(e),e=>this.render()),this.loop.start()}startGame(){this.clearScene();let e=$c.createGround(200);this.scene.add(e),jl(this.scene),this.createBoundary(),this.objects=Rl(this.scene),this.particles=new Bl(this.scene),this.playerHole=new $c,this.scene.add(this.playerHole.group),this.playerX=0,this.playerZ=10,this.playerRadius=Gl,this.totalVolume=0,this.score=0,this.speed=15,this.lastTier=0,this.playerHole.setPosition(this.playerX,this.playerZ),this.playerHole.setRadius(this.playerRadius),this.aiHoles=[];let t=[15277667,16750592,10233776,48340,9159498];for(let e=0;e<4;e++){let n=new $c(t[e]);this.scene.add(n.group);let r=e/4*Math.PI*2;this.aiHoles.push({renderer:n,x:Math.cos(r)*25,z:Math.sin(r)*25,radius:Gl,totalVolume:0,score:0,speed:7+Math.random()*4,targetX:0,targetZ:0,name:Hl[e],color:Ul[e]})}this.timer=Wl,this.gameState=`playing`,this.menuEl.style.display=`none`,this.gameOverEl.style.display=`none`,this.hudEl.style.display=`flex`,this.leaderboardEl.style.display=`block`,this.minimapEl.style.display=`block`}clearScene(){let e=[];this.scene.traverse(t=>{(t instanceof q||t instanceof sn)&&e.push(t)});for(let t of e)t.removeFromParent();this.scene=Qc()}createBoundary(){let e=new Br({color:1713022,transparent:!0,opacity:.3}),t=[{x:0,z:-ql,sx:164,sz:2},{x:0,z:ql,sx:164,sz:2},{x:-ql,z:0,sx:2,sz:164},{x:ql,z:0,sx:2,sz:164}];for(let n of t){let t=new q(new J(n.sx,3,n.sz),e);t.position.set(n.x,3/2,n.z),t.renderOrder=3,this.scene.add(t)}}update(e){if(this.gameState!==`playing`)return;if(this.timer-=e,this.timer<=0){this.timer=0,this.endGame();return}let t=this.input.getMovement(),n=this.speed*(1-this.playerRadius*.01);this.playerX+=t.x*n*e,this.playerZ+=t.z*n*e,this.playerX=Tl(this.playerX,-ql+2,ql-2),this.playerZ=Tl(this.playerZ,-ql+2,ql-2),this.playerHole.setPosition(this.playerX,this.playerZ),this.checkConsumption(this.playerX,this.playerZ,this.playerRadius,!0),this.updateConsumingAnimations(e),this.particles.update(e),this.checkHoleVsHole(),this.updateAI(e),this.updateCamera(e),this.updateHUD(),this.updateMinimap()}checkHoleVsHole(){for(let e of this.aiHoles){if(!e.renderer.group.visible)continue;let t=El(this.playerX,this.playerZ,e.x,e.z);this.playerRadius>e.radius*1.3&&t<this.playerRadius*.6&&(e.renderer.group.visible=!1,this.totalVolume+=e.totalVolume*.5,this.playerRadius=Gl*(1+this.totalVolume/Kl)**(1/3),this.playerHole.setRadius(this.playerRadius),this.score+=200,this.particles.burst(e.x,.1,e.z,15,16732754),this.audio.playBigEat(),this.showScorePopup(e.x,e.z,200)),e.radius>this.playerRadius*1.3&&t<e.radius*.6&&(this.playerX=Dl(-ql+10,ql-10),this.playerZ=Dl(-ql+10,ql-10),this.totalVolume=Math.max(0,this.totalVolume*.3),this.playerRadius=Gl*(1+this.totalVolume/Kl)**(1/3),this.playerHole.setRadius(this.playerRadius),this.score=Math.max(0,this.score-100),this.particles.burst(this.playerX,.1,this.playerZ,10,5227511),this.audio.playDeath())}}checkConsumption(e,t,n,r){let i=0;for(let a of this.objects){if(a.consumed||a.consuming||!rl(n,a.tier))continue;let o=El(e,t,a.x,a.z);if(o<n*2&&o>n*.2){let r=.06*(1-o/(n*2)),i=e-a.x,s=t-a.z,c=Math.sqrt(i*i+s*s)||1;a.x+=i/c*r,a.z+=s/c*r,a.mesh.position.x=a.x,a.mesh.position.z=a.z,o=El(e,t,a.x,a.z)}if(o<n*1){if(a.consuming=!0,a.consumeProgress=0,a.originalY=a.mesh.position.y,a.originalScale=1,a.holeX=e,a.holeZ=t,this.particles.burst(a.x,.1,a.z,6+a.tier*2,12364452),r){this.totalVolume+=a.volume,this.playerRadius=Gl*(1+this.totalVolume/Kl)**(1/3),this.playerHole.setRadius(this.playerRadius),this.score+=a.points,this.audio.playEat(a.tier);let e=nl(this.playerRadius);e>this.lastTier&&(this.lastTier=e,this.audio.playTierUp(),this.showSizeUp(el[e])),this.showScorePopup(a.x,a.z,a.points)}i++}}return i}updateConsumingAnimations(e){for(let t of this.objects)if(t.consuming)if(t.consumeProgress+=e*2.5,t.consumeProgress>=1)t.consumed=!0,t.consuming=!1,t.mesh.visible=!1;else{let n=t.consumeProgress,r=1-n;t.mesh.scale.set(r,r,r),t.mesh.position.x=wl(t.x,t.holeX,n*n),t.mesh.position.z=wl(t.z,t.holeZ,n*n),t.mesh.position.y=t.originalY-n*n*4,t.mesh.rotation.y+=e*(8+n*15)}}scorePopups=[];showScorePopup(e,t,n){let r=document.createElement(`div`);r.textContent=`+${n}`,r.style.cssText=`
    ...
    `;let i=new U(e,2,t);i.project(this.camera);let a=(i.x*.5+.5)*window.innerWidth,o=(-i.y*.5+.5)*window.innerHeight;r.style.left=`${a}px`,r.style.top=`${o}px`,document.getElementById(`ui-overlay`).appendChild(r),requestAnimationFrame(()=>{r.style.transform=`translateY(-60px)`,r.style.opacity=`0`}),this.scorePopups.push({el:r,life:0}),setTimeout(()=>{r.remove(),this.scorePopups=this.scorePopups.filter(e=>e.el!==r)},900)}sizeUpTimeout=null;showSizeUp(e){this.sizeUpEl.textContent=`SIZE UP! ${e}`,this.sizeUpEl.classList.add(`show`),this.sizeUpTimeout&&clearTimeout(this.sizeUpTimeout),this.sizeUpTimeout=setTimeout(()=>{this.sizeUpEl.classList.remove(`show`)},1500)}updateMinimap(){let e=this.minimapCtx,t=100/160;e.clearRect(0,0,100,100),e.fillStyle=`#2d5a3e`,e.fillRect(0,0,100,100),e.fillStyle=`#37474f`,e.fillRect(0,100/2-2,100,4),e.fillRect(100/2-2,0,4,100);for(let n of this.aiHoles){if(!n.renderer.group.visible)continue;let r=(n.x+160/2)*t,i=(n.z+160/2)*t;e.fillStyle=n.color,e.beginPath(),e.arc(r,i,Math.max(2,n.radius*t),0,Math.PI*2),e.fill()}let n=(this.playerX+160/2)*t,r=(this.playerZ+160/2)*t;e.fillStyle=`#4fc3f7`,e.beginPath(),e.arc(n,r,Math.max(3,this.playerRadius*t),0,Math.PI*2),e.fill(),e.strokeStyle=`#fff`,e.lineWidth=1,e.stroke()}updateAI(e){for(let t of this.aiHoles){if(El(t.x,t.z,t.targetX,t.targetZ)<2||Math.random()<.02){let e=null,n=1/0;for(let r of this.objects){if(r.consumed||r.consuming||!rl(t.radius,r.tier))continue;let i=El(t.x,t.z,r.x,r.z);i<n&&(n=i,e=r)}e?(t.targetX=e.x,t.targetZ=e.z):(t.targetX=Dl(-ql+10,ql-10),t.targetZ=Dl(-ql+10,ql-10))}let n=0,r=0;if(this.playerRadius>t.radius*1.3&&El(t.x,t.z,this.playerX,this.playerZ)<this.playerRadius*3){let e=t.x-this.playerX,i=t.z-this.playerZ,a=Math.sqrt(e*e+i*i)||1;n=e/a*2,r=i/a*2}let i=t.targetX-t.x+n,a=t.targetZ-t.z+r,o=Math.sqrt(i*i+a*a)||1,s=t.speed*(1-t.radius*.008);t.x+=i/o*s*e,t.z+=a/o*s*e,t.x=Tl(t.x,-ql+2,ql-2),t.z=Tl(t.z,-ql+2,ql-2),t.renderer.setPosition(t.x,t.z);for(let e of this.objects)e.consumed||e.consuming||rl(t.radius,e.tier)&&El(t.x,t.z,e.x,e.z)<t.radius*.85&&(e.consuming=!0,e.consumeProgress=0,e.originalY=e.mesh.position.y,e.holeX=t.x,e.holeZ=t.z,this.particles.burst(e.x,.1,e.z,4,12364452),t.totalVolume+=e.volume,t.radius=Gl*(1+t.totalVolume/Kl)**(1/3),t.renderer.setRadius(t.radius),t.score+=e.points)}}updateCamera(e){let t=15+this.playerRadius*3,n=10+this.playerRadius*2;this.camera.position.x=wl(this.camera.position.x,this.playerX,.05),this.camera.position.z=wl(this.camera.position.z,this.playerZ+n,.05),this.camera.position.y=wl(this.camera.position.y,t,.05),this.camera.lookAt(wl(this.camera.position.x,this.playerX,.5),0,wl(this.camera.position.z-n,this.playerZ,.5))}updateHUD(){let e=Math.floor(this.timer/60),t=Math.floor(this.timer%60);this.timerEl.textContent=`${e}:${t.toString().padStart(2,`0`)}`,this.scoreEl.textContent=`Score: ${this.score}`;let n=nl(this.playerRadius);this.sizeEl.textContent=`Size: ${el[n]}`;let r=[{name:`You`,score:this.score,isPlayer:!0},...this.aiHoles.map(e=>({name:e.name,score:e.score,isPlayer:!1}))].sort((e,t)=>t.score-e.score);this.leaderboardEl.innerHTML=`<h3>Leaderboard</h3>`+r.map((e,t)=>`<div class="lb-entry${e.isPlayer?` player`:``}"><span>${t+1}. ${e.name}</span><span>${e.score}</span></div>`).join(``)}endGame(){this.gameState=`gameover`,this.audio.playGameOver();let e=[{name:`You`,score:this.score,isPlayer:!0},...this.aiHoles.map(e=>({name:e.name,score:e.score,isPlayer:!1}))].sort((e,t)=>t.score-e.score),t=e.findIndex(e=>e.isPlayer)+1;this.finalScoreEl.textContent=`Score: ${this.score}`,this.finalRankEl.textContent=`Rank: #${t} of ${e.length}`,this.hudEl.style.display=`none`,this.leaderboardEl.style.display=`none`,this.minimapEl.style.display=`none`,this.gameOverEl.style.display=`flex`}render(){this.renderer.render(this.scene,this.camera)}}().init().catch(console.error);