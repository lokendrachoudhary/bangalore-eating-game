...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function oo(e,t,n){let r=new Float32Array(Ka),i=new H(0,1,0);return new Ai({name:`SphericalGaussianBlur`,defines:{n:Ka,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:lo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function so(){return new Ai({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:lo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function co(){return new Ai({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:lo(),fragmentShader:`
	...
	`}var uo=class extends At{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new ui([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Is={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Ls(e,t){let n=Is[t];return n===void 0?(L(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Rs=new H;function zs(){return W.getLuminanceCoefficients(Rs),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Rs.x.toFixed(4)}, ${Rs.y.toFixed(4)}, ${Rs.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Os(i,i.VERTEX_SHADER,y),S=Os(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Ps(i,x,`vertex`),n=Ps(i,S,`fragment`);R(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
...
}`,zc=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new mi(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new Ai({vertexShader:Lc,fragmentShader:Rc,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new K(new yi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Bc=class extends rt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,u=null,d=null,f=null,p=null,h=null,g=typeof XRWebGLBinding<`u`,_=new zc,v={},b=t.getContextAttributes(),x=null,S=null,C=[],D=[],ee=new V,O=null,k=new ua;k.viewport=new Ot;let te=new ua;te.viewport=new Ot;let ne=[k,te],A=new va,re=null,j=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new un,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new un,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new un,C[e]=t),t.getHandSpace()};function ie(e){let t=D.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ae(){r.removeEventListener(`select`,ie),r.removeEventListener(`selectstart`,ie),r.removeEventListener(`selectend`,ie),r.removeEventListener(`squeeze`,ie),r.removeEventListener(`squeezestart`,ie),r.removeEventListener(`squeezeend`,ie),r.removeEventListener(`end`,ae),r.removeEventListener(`inputsourceschange`,oe);for(let e=0;e<C.length;e++){let t=D[e];t!==null&&(D[e]=null,C[e].disconnect(t))}re=null,j=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(x),p=null,f=null,d=null,r=null,S=null,pe.stop(),n.isPresenting=!1,e.setPixelRatio(O),e.setSize(ee.width,ee.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&L(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&L(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return h},this.getSession=function(){return r},this.setSession=async function(u){if(r=u,r!==null){if(x=e.getRenderTarget(),r.addEventListener(`select`,ie),r.addEventListener(`selectstart`,ie),r.addEventListener(`selectend`,ie),r.addEventListener(`squeeze`,ie),r.addEventListener(`squeezestart`,ie),r.addEventListener(`squeezeend`,ie),r.addEventListener(`end`,ae),r.addEventListener(`inputsourceschange`,oe),b.xrCompatible!==!0&&await t.makeXRCompatible(),O=e.getPixelRatio(),e.getSize(ee),g&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;b.depth&&(o=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=b.stencil?E:T,a=b.stencil?y:m);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};d=this.getBinding(),f=d.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new At(f.textureWidth,f.textureHeight,{format:w,type:l,depthTexture:new fi(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new At(p.framebufferWidth,p.framebufferHeight,{format:w,type:l,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),pe.setContext(r),pe.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function oe(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=D.indexOf(n);r>=0&&(D[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=D.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=D.length){D.push(n),r=e;break}else if(D[e]===null){D[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let M=new H,se=new H;function ce(e,t,n){M.setFromMatrixPosition(t.matrixWorld),se.setFromMatrixPosition(n.matrixWorld);let r=M.distanceTo(se),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function le(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),A.near=te.near=k.near=t,A.far=te.far=k.far=n,(re!==A.near||j!==A.far)&&(r.updateRenderState({depthNear:A.near,depthFar:A.far}),re=A.near,j=A.far),A.layers.mask=e.layers.mask|6,k.layers.mask=A.layers.mask&-5,te.layers.mask=A.layers.mask&-3;let i=e.parent,a=A.cameras;le(A,i);for(let e=0;e<a.length;e++)le(a[e],i);a.length===2?ce(A,k,te):A.projectionMatrix.copy(k.projectionMatrix),ue(e,A,i)};function ue(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=ot*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return A},this.getFoveation=function(){if(!(f===null&&p===null))return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(A)},this.getCameraTexture=function(e){return v[e]};let de=null;function fe(t,i){if(u=i.getViewerPose(c||a),h=i,u!==null){let t=u.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==A.cameras.length&&(A.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=d.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=ne[n];o===void 0&&(o=new ua,o.layers.enable(n),o.viewport=new Ot,ne[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(A.matrix.copy(o.matrix),A.matrix.decompose(A.position,A.quaternion,A.scale)),i===!0&&A.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&g){d=n.getBinding();let e=d.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&g){e.state.unbindTexture(),d=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new mi,v[n]=e);let t=d.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=D[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}de&&de(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),h=null}let pe=new Na;pe.setAnimationLoop(fe),this.setAnimationLoop=function(e){de=e},this.dispose=function(){}}},Vc=new Ut,Hc=new Nt;function Uc(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,Ei(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,Vc.copy(o),Vc.x*=-1,Vc.y*=-1,Vc.z*=-1,a.isCubeTexture&&a.isRenderTargetTexture===!1&&(Vc.y*=-1,Vc.z*=-1),e.envMapRotation.value.setFromMatrix4(Hc.makeRotationFromEuler(Vc)),e.flipEnvMap.value=a.isCubeTexture&&a.isRenderTargetTexture===!1?-1:1,e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function Wc(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(m(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,g));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return R(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let t=0,n=r.length;t<n;t++){let n=Array.isArray(r[t])?r[t]:[r[t]];for(let r=0,i=n.length;r<i;r++){let i=n[r];if(p(i,t,r,a)===!0){let t=i.__offset,n=Array.isArray(i.value)?i.value:[i.value],r=0;for(let a=0;a<n.length;a++){let o=n[a],s=h(o);typeof o==`number`||typeof o==`boolean`?(i.__data[0]=o,e.bufferSubData(e.UNIFORM_BUFFER,t+r,i.__data)):o.isMatrix3?(i.__data[0]=o.elements[0],i.__data[1]=o.elements[1],i.__data[2]=o.elements[2],i.__data[3]=0,i.__data[4]=o.elements[3],i.__data[5]=o.elements[4],i.__data[6]=o.elements[5],i.__data[7]=0,i.__data[8]=o.elements[6],i.__data[9]=o.elements[7],i.__data[10]=o.elements[8],i.__data[11]=0):(o.toArray(i.__data,r),r+=s.storage/Float32Array.BYTES_PER_ELEMENT)}e.bufferSubData(e.UNIFORM_BUFFER,t,i.__data)}}}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function m(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=h(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function h(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?L(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):L(`WebGLRenderer: Unsupported uniform value type.`,e),t}function g(t){let n=t.target;n.removeEventListener(`dispose`,g);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function _(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:_}}var Gc=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Kc=null;function qc(){return Kc===null&&(Kc=new ti(Gc,16,16,O,g),Kc.name=`DFG_LUT`,Kc.minFilter=o,Kc.magFilter=o,Kc.wrapS=t,Kc.wrapT=t,Kc.generateMipmaps=!1,Kc.needsUpdate=!0),Kc}var Jc=class{constructor(e={}){let{canvas:t=Ye(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:u=!1,powerPreference:d=`default`,failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:b=l}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);x=n.getContextAttributes().alpha}else x=a;let S=b,C=new Set([te,k,ee]),w=new Set([l,m,f,y,_,v]),T=new Uint32Array(4),E=new Int32Array(4),D=null,O=null,ne=[],A=[],re=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let j=this,ie=!1;this._outputColorSpace=ze;let ae=0,oe=0,M=null,se=-1,ce=null,le=new Ot,ue=new Ot,de=null,fe=new G(0),pe=0,me=t.width,he=t.height,ge=1,_e=null,ve=null,ye=new Ot(0,0,me,he),be=new Ot(0,0,me,he),xe=!1,Se=new li,Ce=!1,we=!1,Te=new Nt,Ee=new H,De=new Ot,Oe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},ke=!1;function Ae(){return M===null?ge:1}let N=n;function je(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:p};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r183`),t.addEventListener(`webglcontextlost`,st,!1),t.addEventListener(`webglcontextrestored`,z,!1),t.addEventListener(`webglcontextcreationerror`,ct,!1),N===null){let t=`webgl2`;if(N=je(t,e),N===null)throw je(t)?Error(`Error creating WebGL context with your selected attributes.`):Error(`Error creating WebGL context.`)}}catch(e){throw R(`WebGLRenderer: `+e.message),e}let Me,Ne,P,Pe,F,I,Fe,Ie,Le,Re,Ve,He,Ue,We,Ke,qe,Je,Xe,Ze,$e,nt,rt,it;function at(){Me=new po(N),Me.init(),nt=new Ic(N,Me),Ne=new Ha(N,Me,e,nt),P=new Pc(N,Me),Ne.reversedDepthBuffer&&h&&P.buffers.depth.setReversed(!0),Pe=new go(N),F=new mc,I=new Fc(N,Me,P,F,Ne,nt,Pe),Fe=new fo(j),Ie=new Pa(N),rt=new Ba(N,Ie),Le=new mo(N,Ie,Pe,rt),Re=new vo(N,Le,Ie,rt,Pe),Xe=new _o(N,Ne,I),Ke=new Ua(F),Ve=new pc(j,Fe,Me,Ne,rt,Ke),He=new Uc(j,F),Ue=new vc,We=new Tc(Me),Je=new za(j,Fe,P,Re,x,s),qe=new Nc(j,Re,Ne),it=new Wc(N,Pe,Ne,P),Ze=new Va(N,Me,Pe),$e=new ho(N,Me,Pe),Pe.programs=Ve.programs,j.capabilities=Ne,j.extensions=Me,j.properties=F,j.renderLists=Ue,j.shadowMap=qe,j.state=P,j.info=Pe}at(),S!==1009&&(re=new bo(S,t.width,t.height,r,i));let ot=new Bc(j,N);this.xr=ot,this.getContext=function(){return N},this.getContextAttributes=function(){return N.getContextAttributes()},this.forceContextLoss=function(){let e=Me.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=Me.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return ge},this.setPixelRatio=function(e){e!==void 0&&(ge=e,this.setSize(me,he,!1))},this.getSize=function(e){return e.set(me,he)},this.setSize=function(e,n,r=!0){if(ot.isPresenting){L(`WebGLRenderer: Can't change size while VR device is presenting.`);return}me=e,he=n,t.width=Math.floor(e*ge),t.height=Math.floor(n*ge),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),re!==null&&re.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(me*ge,he*ge).floor()},this.setDrawingBufferSize=function(e,n,r){me=e,he=n,ge=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){console.error(`THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){console.warn(`THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}re.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(le)},this.getViewport=function(e){return e.copy(ye)},this.setViewport=function(e,t,n,r){e.isVector4?ye.set(e.x,e.y,e.z,e.w):ye.set(e,t,n,r),P.viewport(le.copy(ye).multiplyScalar(ge).round())},this.getScissor=function(e){return e.copy(be)},this.setScissor=function(e,t,n,r){e.isVector4?be.set(e.x,e.y,e.z,e.w):be.set(e,t,n,r),P.scissor(ue.copy(be).multiplyScalar(ge).round())},this.getScissorTest=function(){return xe},this.setScissorTest=function(e){P.setScissorTest(xe=e)},this.setOpaqueSort=function(e){_e=e},this.setTransparentSort=function(e){ve=e},this.getClearColor=function(e){return e.copy(Je.getClearColor())},this.setClearColor=function(){Je.setClearColor(...arguments)},this.getClearAlpha=function(){return Je.getClearAlpha()},this.setClearAlpha=function(){Je.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(M!==null){let t=M.texture.format;e=C.has(t)}if(e){let e=M.texture.type,t=w.has(e),n=Je.getClearColor(),r=Je.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,N.clearBufferuiv(N.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,N.clearBufferiv(N.COLOR,0,E))}else r|=N.COLOR_BUFFER_BIT}t&&(r|=N.DEPTH_BUFFER_BIT),n&&(r|=N.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&N.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener(`webglcontextlost`,st,!1),t.removeEventListener(`webglcontextrestored`,z,!1),t.removeEventListener(`webglcontextcreationerror`,ct,!1),Je.dispose(),Ue.dispose(),We.dispose(),F.dispose(),Fe.dispose(),Re.dispose(),rt.dispose(),it.dispose(),Ve.dispose(),ot.dispose(),ot.removeEventListener(`sessionstart`,pt),ot.removeEventListener(`sessionend`,U),mt.stop()};function st(e){e.preventDefault(),Qe(`WebGLRenderer: Context Lost.`),ie=!0}function z(){Qe(`WebGLRenderer: Context Restored.`),ie=!1;let e=Pe.autoReset,t=qe.enabled,n=qe.autoUpdate,r=qe.needsUpdate,i=qe.type;at(),Pe.autoReset=e,qe.enabled=t,qe.autoUpdate=n,qe.needsUpdate=r,qe.type=i}function ct(e){R(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function lt(e){let t=e.target;t.removeEventListener(`dispose`,lt),ut(t)}function ut(e){B(e),F.remove(e)}function B(e){let t=F.get(e).programs;t!==void 0&&(t.forEach(function(e){Ve.releaseProgram(e)}),e.isShaderMaterial&&Ve.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=Oe);let o=i.isMesh&&i.matrixWorld.determinant()<0,s=Ct(e,t,n,r,i);P.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Le.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;rt.setup(i,r,s,n,c);let h,g=Ze;if(c!==null&&(h=Ie.get(c),g=$e,g.setIndex(h)),i.isMesh)r.wireframe===!0?(P.setLineWidth(r.wireframeLinewidth*Ae()),g.setMode(N.LINES)):g.setMode(N.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),P.setLineWidth(e*Ae()),i.isLineSegments?g.setMode(N.LINES):i.isLineLoop?g.setMode(N.LINE_LOOP):g.setMode(N.LINE_STRIP)}else i.isPoints?g.setMode(N.POINTS):i.isSprite&&g.setMode(N.TRIANGLES);if(i.isBatchedMesh)if(i._multiDrawInstances!==null)et(`WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection.`),g.renderMultiDrawInstances(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount,i._multiDrawInstances);else if(Me.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Ie.get(c).bytesPerElement:1,o=F.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(N,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function V(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,bt(e,t,n),e.side=0,e.needsUpdate=!0,bt(e,t,n),e.side=2):bt(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),O=We.get(n),O.init(t),A.push(O),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(O.pushLight(e),e.castShadow&&O.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(O.pushLight(e),e.castShadow&&O.pushShadow(e))}),O.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];V(a,n,e),r.add(a)}else V(t,n,e),r.add(t)}),O=A.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){F.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}Me.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let dt=null;function ft(e){dt&&dt(e)}function pt(){mt.stop()}function U(){mt.start()}let mt=new Na;mt.setAnimationLoop(ft),typeof self<`u`&&mt.setContext(self),this.setAnimationLoop=function(e){dt=e,ot.setAnimationLoop(e),e===null?mt.stop():mt.start()},ot.addEventListener(`sessionstart`,pt),ot.addEventListener(`sessionend`,U),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){R(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ie===!0)return;let n=ot.enabled===!0&&ot.isPresenting===!0,r=re!==null&&(M===null||n)&&re.begin(j,M);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),ot.enabled===!0&&ot.isPresenting===!0&&(re===null||re.isCompositing()===!1)&&(ot.cameraAutoUpdate===!0&&ot.updateCamera(t),t=ot.getCamera()),e.isScene===!0&&e.onBeforeRender(j,e,t,M),O=We.get(e,A.length),O.init(t),A.push(O),Te.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),Se.setFromProjectionMatrix(Te,Ge,t.reversedDepth),we=this.localClippingEnabled,Ce=Ke.init(this.clippingPlanes,we),D=Ue.get(e,ne.length),D.init(),ne.push(D),ot.enabled===!0&&ot.isPresenting===!0){let e=j.xr.getDepthSensingMesh();e!==null&&ht(e,t,-1/0,j.sortObjects)}ht(e,t,0,j.sortObjects),D.finish(),j.sortObjects===!0&&D.sort(_e,ve),ke=ot.enabled===!1||ot.isPresenting===!1||ot.hasDepthSensing()===!1,ke&&Je.addToRenderList(D,e),this.info.render.frame++,Ce===!0&&Ke.beginShadows();let i=O.state.shadowsArray;if(qe.render(i,e,t),Ce===!0&&Ke.endShadows(),this.info.autoReset===!0&&this.info.reset(),(r&&re.hasRenderPass())===!1){let n=D.opaque,r=D.transmissive;if(O.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];_t(n,r,e,a)}ke&&Je.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];gt(D,e,n,n.viewport)}}else r.length>0&&_t(n,r,e,t),ke&&Je.render(e),gt(D,e,t)}M!==null&&oe===0&&(I.updateMultisampleRenderTarget(M),I.updateRenderTargetMipmap(M)),r&&re.end(j),e.isScene===!0&&e.onAfterRender(j,e,t),rt.resetDefaultState(),se=-1,ce=null,A.pop(),A.length>0?(O=A[A.length-1],Ce===!0&&Ke.setGlobalState(j.clippingPlanes,O.state.camera)):O=null,ne.pop(),D=ne.length>0?ne[ne.length-1]:null};function ht(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLight)O.pushLight(e),e.castShadow&&O.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||Se.intersectsSprite(e)){r&&De.setFromMatrixPosition(e.matrixWorld).applyMatrix4(Te);let t=Re.update(e),i=e.material;i.visible&&D.push(e,t,i,n,De.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||Se.intersectsObject(e))){let t=Re.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),De.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),De.copy(e.boundingSphere.center)),De.applyMatrix4(e.matrixWorld).applyMatrix4(Te)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&D.push(e,t,s,n,De.z,o)}}else i.visible&&D.push(e,t,i,n,De.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)ht(i[e],t,n,r)}function gt(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;O.setupLightsView(n),Ce===!0&&Ke.setGlobalState(j.clippingPlanes,n),r&&P.viewport(le.copy(r)),i.length>0&&vt(i,t,n),a.length>0&&vt(a,t,n),o.length>0&&vt(o,t,n),P.buffers.depth.setTest(!0),P.buffers.depth.setMask(!0),P.buffers.color.setMask(!0),P.setPolygonOffset(!1)}function _t(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(O.state.transmissionRenderTarget[r.id]===void 0){let e=Me.has(`EXT_color_buffer_half_float`)||Me.has(`EXT_color_buffer_float`);O.state.transmissionRenderTarget[r.id]=new At(1,1,{generateMipmaps:!0,type:e?g:l,minFilter:c,samples:Math.max(4,Ne.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:W.workingColorSpace})}let a=O.state.transmissionRenderTarget[r.id],o=r.viewport||le;a.setSize(o.z*j.transmissionResolutionScale,o.w*j.transmissionResolutionScale);let s=j.getRenderTarget(),u=j.getActiveCubeFace(),d=j.getActiveMipmapLevel();j.setRenderTarget(a),j.getClearColor(fe),pe=j.getClearAlpha(),pe<1&&j.setClearColor(16777215,.5),j.clear(),ke&&Je.render(n);let f=j.toneMapping;j.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),O.setupLightsView(r),Ce===!0&&Ke.setGlobalState(j.clippingPlanes,r),vt(e,n,r),I.updateMultisampleRenderTarget(a),I.updateRenderTargetMipmap(a),Me.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,yt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(I.updateMultisampleRenderTarget(a),I.updateRenderTargetMipmap(a))}j.setRenderTarget(s,u,d),j.setClearColor(fe,pe),p!==void 0&&(r.viewport=p),j.toneMapping=f}function vt(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&yt(o,t,n,s,l,c)}}function yt(e,t,n,r,i,a){e.onBeforeRender(j,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(j,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,j.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,j.renderBufferDirect(n,t,r,i,e,a),i.side=2):j.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(j,t,n,r,i,a)}function bt(e,t,n){t.isScene!==!0&&(t=Oe);let r=F.get(e),i=O.state.lights,a=O.state.shadowsArray,o=i.state.version,s=Ve.getParameters(e,i.state,a,t,n),c=Ve.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Fe.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,lt),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return St(e,s),d}else s.uniforms=Ve.getUniforms(e),e.onBeforeCompile(s,j),d=Ve.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Ke.uniform),St(e,s),r.needsLights=Tt(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.currentProgram=d,r.uniformsList=null,d}function xt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=Ds.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function St(e,t){let n=F.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function Ct(e,t,n,r,i){t.isScene!==!0&&(t=Oe),I.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=M===null?j.outputColorSpace:M.isXRRenderTarget===!0?M.texture.colorSpace:Be,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Fe.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(M===null||M.isXRRenderTarget===!0)&&(h=j.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=F.get(r),y=O.state.lights;if(Ce===!0&&(we===!0||e!==ce)){let t=e===ce&&r.id===se;Ke.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Ke.numPlanes||v.numIntersection!==Ke.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h?v.morphTargetsCount!==_&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=bt(r,t,i));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(P.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==se&&(se=r.id,C=!0),S||ce!==e){P.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(N,`projectionMatrix`,e.projectionMatrix),T.setValue(N,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(N,Ee.setFromMatrixPosition(e.matrixWorld)),Ne.logarithmicDepthBuffer&&T.setValue(N,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(N,`isOrthographic`,e.isOrthographicCamera===!0),ce!==e&&(ce=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(N,`directionalShadowMap`,y.state.directionalShadowMap,I),y.state.spotShadowMap.length>0&&T.setValue(N,`spotShadowMap`,y.state.spotShadowMap,I),y.state.pointShadowMap.length>0&&T.setValue(N,`pointShadowMap`,y.state.pointShadowMap,I)),i.isSkinnedMesh){T.setOptional(N,i,`bindMatrix`),T.setOptional(N,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(N,`boneTexture`,e.boneTexture,I))}i.isBatchedMesh&&(T.setOptional(N,i,`batchingTexture`),T.setValue(N,`batchingTexture`,i._matricesTexture,I),T.setOptional(N,i,`batchingIdTexture`),T.setValue(N,`batchingIdTexture`,i._indirectTexture,I),T.setOptional(N,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(N,`batchingColorTexture`,i._colorsTexture,I));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&Xe.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(N,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=qc()),C&&(T.setValue(N,`toneMappingExposure`,j.toneMappingExposure),v.needsLights&&wt(E,w),a&&r.fog===!0&&He.refreshFogUniforms(E,a),He.refreshMaterialUniforms(E,r,ge,he,O.state.transmissionRenderTarget[e.id]),Ds.upload(N,xt(v),E,I)),r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(Ds.upload(N,xt(v),E,I),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(N,`center`,i.center),T.setValue(N,`modelViewMatrix`,i.modelViewMatrix),T.setValue(N,`normalMatrix`,i.normalMatrix),T.setValue(N,`modelMatrix`,i.matrixWorld),r.isShaderMaterial||r.isRawShaderMaterial){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];it.update(n,x),it.bind(n,x)}}return x}function wt(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function Tt(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return ae},this.getActiveMipmapLevel=function(){return oe},this.getRenderTarget=function(){return M},this.setRenderTargetTextures=function(e,t,n){let r=F.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),F.get(e.texture).__webglTexture=t,F.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=F.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0};let Et=N.createFramebuffer();this.setRenderTarget=function(e,t=0,n=0){M=e,ae=t,oe=n;let r=null,i=!1,a=!1;if(e){let o=F.get(e);if(o.__useDefaultFramebuffer!==void 0){P.bindFramebuffer(N.FRAMEBUFFER,o.__webglFramebuffer),le.copy(e.viewport),ue.copy(e.scissor),de=e.scissorTest,P.viewport(le),P.scissor(ue),P.setScissorTest(de),se=-1;return}else if(o.__webglFramebuffer===void 0)I.setupRenderTarget(e);else if(o.__hasExternalTextures)I.rebindTextures(e,F.get(e.texture).__webglTexture,F.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&F.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.`);I.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=F.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&I.useMultisampledRTT(e)===!1?F.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,le.copy(e.viewport),ue.copy(e.scissor),de=e.scissorTest}else le.copy(ye).multiplyScalar(ge).floor(),ue.copy(be).multiplyScalar(ge).floor(),de=xe;if(n!==0&&(r=Et),P.bindFramebuffer(N.FRAMEBUFFER,r)&&P.drawBuffers(e,r),P.viewport(le),P.scissor(ue),P.setScissorTest(de),i){let r=F.get(e.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=F.get(e.textures[t]);N.framebufferTextureLayer(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=F.get(e.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,t.__webglTexture,n)}se=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=F.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){P.bindFramebuffer(N.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+s),!Ne.textureFormatReadable(c)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Ne.textureTypeReadable(l)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&N.readPixels(t,n,r,i,nt.convert(c),nt.convert(l),a)}finally{let e=M===null?null:F.get(M).__webglFramebuffer;P.bindFramebuffer(N.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=F.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){P.bindFramebuffer(N.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+s),!Ne.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Ne.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=N.createBuffer();N.bindBuffer(N.PIXEL_PACK_BUFFER,d),N.bufferData(N.PIXEL_PACK_BUFFER,a.byteLength,N.STREAM_READ),N.readPixels(t,n,r,i,nt.convert(l),nt.convert(u),0);let f=M===null?null:F.get(M).__webglFramebuffer;P.bindFramebuffer(N.FRAMEBUFFER,f);let p=N.fenceSync(N.SYNC_GPU_COMMANDS_COMPLETE,0);return N.flush(),await tt(N,p,4),N.bindBuffer(N.PIXEL_PACK_BUFFER,d),N.getBufferSubData(N.PIXEL_PACK_BUFFER,0,a),N.deleteBuffer(d),N.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;I.setTexture2D(e,0),N.copyTexSubImage2D(N.TEXTURE_2D,n,0,0,o,s,i,a),P.unbindTexture()};let Dt=N.createFramebuffer(),kt=N.createFramebuffer();this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=nt.convert(t.format),_=nt.convert(t.type),v;t.isData3DTexture?(I.setTexture3D(t,0),v=N.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(I.setTexture2DArray(t,0),v=N.TEXTURE_2D_ARRAY):(I.setTexture2D(t,0),v=N.TEXTURE_2D),N.pixelStorei(N.UNPACK_FLIP_Y_WEBGL,t.flipY),N.pixelStorei(N.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),N.pixelStorei(N.UNPACK_ALIGNMENT,t.unpackAlignment);let y=N.getParameter(N.UNPACK_ROW_LENGTH),b=N.getParameter(N.UNPACK_IMAGE_HEIGHT),x=N.getParameter(N.UNPACK_SKIP_PIXELS),S=N.getParameter(N.UNPACK_SKIP_ROWS),C=N.getParameter(N.UNPACK_SKIP_IMAGES);N.pixelStorei(N.UNPACK_ROW_LENGTH,h.width),N.pixelStorei(N.UNPACK_IMAGE_HEIGHT,h.height),N.pixelStorei(N.UNPACK_SKIP_PIXELS,l),N.pixelStorei(N.UNPACK_SKIP_ROWS,u),N.pixelStorei(N.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=F.get(e),r=F.get(t),h=F.get(n.__renderTarget),g=F.get(r.__renderTarget);P.bindFramebuffer(N.READ_FRAMEBUFFER,h.__webglFramebuffer),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,F.get(e).__webglTexture,i,d+n),N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,F.get(t).__webglTexture,a,m+n)),N.blitFramebuffer(l,u,o,s,f,p,o,s,N.DEPTH_BUFFER_BIT,N.NEAREST);P.bindFramebuffer(N.READ_FRAMEBUFFER,null),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||F.has(e)){let n=F.get(e),r=F.get(t);P.bindFramebuffer(N.READ_FRAMEBUFFER,Dt),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,kt);for(let e=0;e<c;e++)w?N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):N.framebufferTexture2D(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,n.__webglTexture,i),T?N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):N.framebufferTexture2D(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,r.__webglTexture,a),i===0?T?N.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):N.copyTexSubImage2D(v,a,f,p,l,u,o,s):N.blitFramebuffer(l,u,o,s,f,p,o,s,N.COLOR_BUFFER_BIT,N.NEAREST);P.bindFramebuffer(N.READ_FRAMEBUFFER,null),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?N.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?N.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):N.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?N.texSubImage2D(N.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?N.compressedTexSubImage2D(N.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):N.texSubImage2D(N.TEXTURE_2D,a,f,p,o,s,g,_,h);N.pixelStorei(N.UNPACK_ROW_LENGTH,y),N.pixelStorei(N.UNPACK_IMAGE_HEIGHT,b),N.pixelStorei(N.UNPACK_SKIP_PIXELS,x),N.pixelStorei(N.UNPACK_SKIP_ROWS,S),N.pixelStorei(N.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&N.generateMipmap(v),P.unbindTexture()},this.initRenderTarget=function(e){F.get(e).__webglFramebuffer===void 0&&I.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?I.setTextureCube(e,0):e.isData3DTexture?I.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?I.setTexture2DArray(e,0):I.setTexture2D(e,0),P.unbindTexture()},this.resetState=function(){ae=0,oe=0,M=null,P.reset(),rt.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Ge}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=W._getDrawingBufferColorSpace(e),t.unpackColorSpace=W._getUnpackColorSpace()}},Yc=class{fixedStep=1/60;accumulator=0;lastTime=0;running=!1;rafId=0;updateFn;renderFn;constructor(e,t){this.updateFn=e,this.renderFn=t}start(){this.running=!0,this.lastTime=performance.now(),this.accumulator=0,this.rafId=requestAnimationFrame(e=>this.tick(e))}stop(){this.running=!1,cancelAnimationFrame(this.rafId)}tick(e){if(!this.running)return;let t=Math.min((e-this.lastTime)/1e3,.1);for(this.lastTime=e,this.accumulator+=t;this.accumulator>=this.fixedStep;)this.updateFn(this.fixedStep),this.accumulator-=this.fixedStep;let n=this.accumulator/this.fixedStep;this.renderFn(n),this.rafId=requestAnimationFrame(e=>this.tick(e))}},Xc=class{keys=new Set;moveVector={x:0,z:0};touchActive=!1;touchStartX=0;touchStartY=0;joystickSensitivity=.01;constructor(){window.addEventListener(`keydown`,e=>this.keys.add(e.key.toLowerCase())),window.addEventListener(`keyup`,e=>this.keys.delete(e.key.toLowerCase())),window.addEventListener(`pointerdown`,e=>this.onPointerDown(e)),window.addEventListener(`pointermove`,e=>this.onPointerMove(e)),window.addEventListener(`pointerup`,()=>this.onPointerUp()),window.addEventListener(`pointercancel`,()=>this.onPointerUp())}onPointerDown(e){(e.clientX<window.innerWidth*.6||e.pointerType===`touch`)&&(this.touchActive=!0,this.touchStartX=e.clientX,this.touchStartY=e.clientY)}onPointerMove(e){if(!this.touchActive)return;let t=(e.clientX-this.touchStartX)*this.joystickSensitivity,n=(e.clientY-this.touchStartY)*this.joystickSensitivity,r=Math.sqrt(t*t+n*n);r>1?(this.moveVector.x=t/r*1,this.moveVector.z=n/r*1):r>.1?(this.moveVector.x=t,this.moveVector.z=n):(this.moveVector.x=0,this.moveVector.z=0)}onPointerUp(){this.touchActive=!1,this.moveVector.x=0,this.moveVector.z=0}getMovement(){let e=0,t=0;if((this.keys.has(`w`)||this.keys.has(`arrowup`))&&(t=-1),(this.keys.has(`s`)||this.keys.has(`arrowdown`))&&(t=1),(this.keys.has(`a`)||this.keys.has(`arrowleft`))&&(e=-1),(this.keys.has(`d`)||this.keys.has(`arrowright`))&&(e=1),e!==0&&t!==0){let n=1/Math.SQRT2;e*=n,t*=n}return this.touchActive?{x:this.moveVector.x,z:this.moveVector.z}:{x:e,z:t}}};function Zc(e){let t=new Jc({antialias:!0,powerPreference:`high-performance`});return t.setSize(window.innerWidth,window.innerHeight),t.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.shadowMap.enabled=!1,t.setClearColor(9357544),e.insertBefore(t.domElement,e.firstChild),window.addEventListener(`resize`,()=>{t.setSize(window.innerWidth,window.innerHeight)}),t}function Qc(){let e=new ua(50,window.innerWidth/window.innerHeight,.1,500);return e.position.set(0,25,20),e.lookAt(0,0,0),window.addEventListener(`resize`,()=>{e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix()}),e}function $c(){let e=new _n;e.fog=new gn(9357544,100,250);let t=new ma(16775393,.6);e.add(t);let n=new pa(16774112,.9);n.position.set(50,80,30),e.add(n);let r=new Qi(8900331,4881497,.3);return e.add(r),e}var el=class{group;holeSurface;holeInterior;rim;innerRim;currentRadius=1.5;constructor(e=1710638){this.group=new cn,this.holeSurface=new K(new gi(1,64),new Vr({color:328965,depthWrite:!0})),this.holeSurface.rotation.x=-Math.PI/2,this.holeSurface.position.y=.03,this.holeSurface.renderOrder=1,this.group.add(this.holeSurface),this.holeInterior=new K(new xi(1,32,16,0,Math.PI*2,0,Math.PI/2),new Mi({color:657930,roughness:1,metalness:0,side:1})),this.holeInterior.rotation.x=Math.PI,this.holeInterior.position.y=-.05,this.holeInterior.renderOrder=0,this.group.add(this.holeInterior),this.rim=new K(new bi(.92,1,64),new Vr({color:e,side:2})),this.rim.rotation.x=-Math.PI/2,this.rim.position.y=.04,this.rim.renderOrder=2,this.group.add(this.rim),this.innerRim=new K(new bi(.7,.95,64),new Vr({color:1118498,transparent:!0,opacity:.5,side:2})),this.innerRim.rotation.x=-Math.PI/2,this.innerRim.position.y=.035,this.innerRim.renderOrder=1,this.group.add(this.innerRim),this.setRadius(this.currentRadius)}setRadius(e){this.currentRadius=e,this.holeSurface.scale.set(e,e,1),this.holeInterior.scale.set(e,e*.5,e),this.rim.scale.set(e,e,1),this.innerRim.scale.set(e,e,1)}getRadius(){return this.currentRadius}setPosition(e,t){this.group.position.set(e,0,t)}static createGround(e){let t=new K(new yi(e,e),new Mi({color:5929554,roughness:.9}));return t.rotation.x=-Math.PI/2,t.position.y=0,t.renderOrder=0,t}},X={XS:0,S:1,M:2,L:3,XL:4},tl=[`XS`,`S`,`M`,`L`,`XL`],nl={[X.XS]:1,[X.S]:2,[X.M]:4,[X.L]:7,[X.XL]:12};X.XS,X.S,X.M,X.L,X.XL,X.XS,X.S,X.M,X.L,X.XL;function rl(e){return e>=nl[X.XL]?X.XL:e>=nl[X.L]?X.L:e>=nl[X.M]?X.M:e>=nl[X.S]?X.S:X.XS}function il(e,t){return e>=nl[t]}var Z={rickshawGreen:3046706,rickshawBlack:2171169,rickshawYellow:16761095,bmtcRed:12986408,bmtcBlue:1402304,buildingWhite:15527921,buildingGray:7901340,buildingBrown:9268835,treeTrunk:6111287,treeGreen:3706428,treeDarkGreen:1793568,coneOrange:16739584,personSkin:16764032,personClothes:[15277667,2201331,5025616,16750592,10233776],cartWood:9268835,cartRed:15684432,vidhanaGray:9479342,vidhanaDome:7901340,palaceYellow:16766287,iskconWhite:16448250,iskconGold:16761095,lampPostGray:6381921,lampYellow:16772696,itParkBlue:4367861,itParkGlass:12312315};function Q(e){return new Mi({color:e,flatShading:!0,roughness:.8})}function al(){let e=new cn,t=new K(new vi(.15,.5,6),Q(Z.coneOrange));t.position.y=.25,e.add(t);let n=new K(new q(.35,.05,.35),Q(3355443));return n.position.y=.025,e.add(n),{mesh:e,tier:X.XS,points:10,volume:1,name:`Traffic Cone`,objectRadius:.2}}function ol(){let e=new cn,t=new K(new _i(.15,.2,.25,6),Q(Z.cartRed));t.position.y=.125,e.add(t);let n=new K(new xi(.25,6,4),Q(Z.treeGreen));return n.position.y=.45,e.add(n),{mesh:e,tier:X.XS,points:10,volume:1,name:`Plant`,objectRadius:.3}}function sl(){let e=new cn,t=new K(new q(.8,.5,.5),Q(Z.cartWood));t.position.y=.45,e.add(t);for(let t of[-.3,.3]){let n=new K(new _i(.12,.12,.05,8),Q(3355443));n.rotation.z=Math.PI/2,n.position.set(t,.12,.28),e.add(n)}let n=new K(new vi(.5,.3,8),Q(Z.cartRed));return n.position.y=1,e.add(n),{mesh:e,tier:X.XS,points:15,volume:2,name:`Food Cart`,objectRadius:.5}}function cl(){let e=new cn,t=new K(new _i(.04,.05,1.5,6),Q(Z.lampPostGray));t.position.y=.75,e.add(t);let n=new K(new xi(.12,6,4),Q(Z.lampYellow));return n.position.y=1.55,e.add(n),{mesh:e,tier:X.XS,points:10,volume:1,name:`Lamp Post`,objectRadius:.15}}function ll(){let e=new cn,t=Z.personClothes[Math.floor(Math.random()*Z.personClothes.length)],n=new K(new hi(.15,.5,4,6),Q(t));n.position.y=.6,e.add(n);let r=new K(new xi(.12,6,4),Q(Z.personSkin));return r.position.y=1.05,e.add(r),{mesh:e,tier:X.S,points:25,volume:3,name:`Person`,objectRadius:.2}}function ul(){let e=new cn,t=new K(new _i(.08,.12,1,6),Q(Z.treeTrunk));t.position.y=.5,e.add(t);let n=new K(new vi(.6,1.2,6),Q(Z.treeGreen));return n.position.y=1.5,e.add(n),{mesh:e,tier:X.S,points:20,volume:4,name:`Tree`,objectRadius:.6}}function dl(){let e=new cn,t=new K(new q(.8,.06,.3),Q(Z.cartWood));t.position.y=.35,e.add(t);for(let t of[-.35,.35]){let n=new K(new q(.05,.35,.25),Q(4342338));n.position.set(t,.175,0),e.add(n)}let n=new K(new q(.8,.4,.04),Q(Z.cartWood));return n.position.set(0,.55,-.13),e.add(n),{mesh:e,tier:X.S,points:20,volume:3,name:`Bench`,objectRadius:.5}}function fl(){let e=new cn,t=new K(new q(.9,.7,.7),Q(Z.rickshawGreen));t.position.y=.55,e.add(t);let n=new K(new q(.85,.08,.65),Q(Z.rickshawBlack));n.position.y=.95,e.add(n);let r=new K(new q(.3,.5,.5),Q(Z.rickshawGreen));r.position.set(.55,.45,0),e.add(r);let i=new K(new xi(.06,6,4),Q(Z.rickshawYellow));i.position.set(.7,.5,0),e.add(i);let a=Q(2171169),o=new _i(.12,.12,.08,8),s=new K(o,a);s.rotation.z=Math.PI/2,s.position.set(.55,.12,0),e.add(s);for(let t of[-.35,.35]){let n=new K(o,a);n.rotation.z=Math.PI/2,n.position.set(-.2,.12,t),e.add(n)}return{mesh:e,tier:X.M,points:50,volume:12,name:`Auto Rickshaw`,objectRadius:.7}}function pl(){let e=new cn,t=[1402304,12986408,16119285,4342338,16748288],n=t[Math.floor(Math.random()*t.length)],r=new K(new q(1.6,.5,.8),Q(n));r.position.y=.4,e.add(r);let i=new K(new q(.9,.4,.75),Q(12312315));i.position.set(-.1,.8,0),e.add(i);let a=Q(2171169),o=new _i(.15,.15,.08,8);for(let t of[-.5,.5])for(let n of[-.4,.4]){let r=new K(o,a);r.rotation.x=Math.PI/2,r.position.set(t,.15,n),e.add(r)}return{mesh:e,tier:X.M,points:40,volume:15,name:`Car`,objectRadius:.9}}function ml(){let e=new cn,t=new K(new q(3.5,1.2,1.2),Q(Z.bmtcRed));t.position.y=1,e.add(t);let n=new K(new q(3.52,.25,1.22),Q(Z.bmtcBlue));n.position.y=.6,e.add(n);let r=Q(12312315),i=new q(.3,.35,1.22);for(let t=-1.2;t<=1.2;t+=.5){let n=new K(i,r);n.position.set(t,1.2,0),e.add(n)}let a=Q(2171169),o=new _i(.25,.25,.1,8);for(let t of[-1.2,1.2])for(let n of[-.6,.6]){let r=new K(o,a);r.rotation.x=Math.PI/2,r.position.set(t,.25,n),e.add(r)}return{mesh:e,tier:X.L,points:100,volume:50,name:`BMTC Bus`,objectRadius:1.8}}function hl(){let e=new cn,t=2+Math.random()*3,n=[Z.buildingWhite,Z.buildingGray,Z.buildingBrown,16769202,13166281],r=n[Math.floor(Math.random()*n.length)],i=new K(new q(2,t,2),Q(r));i.position.y=t/2,e.add(i);let a=Q(9489145);for(let n=.8;n<t-.3;n+=.8)for(let t of[-.6,0,.6]){let r=new K(new q(.01,.35,.25),a);r.position.set(1.01,n,t),e.add(r);let i=r.clone();i.position.set(-1.01,n,t),e.add(i)}return{mesh:e,tier:X.L,points:80,volume:40,name:`Building`,objectRadius:1.5}}function gl(){let e=new cn,t=new K(new q(8,3,5),Q(Z.vidhanaGray));t.position.y=1.5,e.add(t);let n=new K(new q(6,1.5,4),Q(Z.vidhanaGray));n.position.y=3.75,e.add(n);let r=new K(new xi(1.2,8,6,0,Math.PI*2,0,Math.PI/2),Q(Z.vidhanaDome));r.position.y=4.5,e.add(r);let i=Q(11583173);for(let t=-3;t<=3;t+=1){let n=new K(new _i(.15,.15,3,6),i);n.position.set(t,1.5,2.55),e.add(n)}let a=new K(new q(8.5,.4,2),Q(13621468));return a.position.set(0,.2,3.5),e.add(a),{mesh:e,tier:X.XL,points:500,volume:200,name:`Vidhana Soudha`,objectRadius:5}}function _l(){let e=new cn,t=new K(new q(6,3,4),Q(Z.palaceYellow));t.position.y=1.5,e.add(t);let n=Q(16761095);for(let t of[-2.8,2.8])for(let r of[-1.8,1.8]){let i=new K(new _i(.5,.5,4.5,6),n);i.position.set(t,2.25,r),e.add(i);let a=new K(new vi(.6,1,6),Q(13840175));a.position.set(t,5,r),e.add(a)}let r=new K(new _i(.6,.6,5.5,8),n);r.position.y=2.75,e.add(r);let i=new K(new vi(.7,1.2,8),Q(13840175));return i.position.y=6.1,e.add(i),{mesh:e,tier:X.XL,points:500,volume:200,name:`Bangalore Palace`,objectRadius:4}}function vl(){let e=new cn,t=new K(new q(5,.5,5),Q(Z.iskconWhite));t.position.y=.25,e.add(t);let n=new K(new q(4,3,4),Q(Z.iskconWhite));n.position.y=2,e.add(n);let r=new K(new vi(1.2,4,8),Q(Z.iskconGold));r.position.y=5.5,e.add(r);for(let t of[-1.5,1.5]){let n=new K(new vi(.6,2.5,6),Q(Z.iskconGold));n.position.set(t,4.75,0),e.add(n)}let i=new K(new xi(.3,8,6),Q(Z.iskconGold));return i.position.y=7.7,e.add(i),{mesh:e,tier:X.XL,points:500,volume:200,name:`ISKCON Temple`,objectRadius:3.5}}function yl(){let e=new cn,t=5+Math.random()*3,n=new K(new q(3,t,3),Q(Z.itParkGlass));n.position.y=t/2,e.add(n);let r=Q(Z.itParkBlue);for(let n=.5;n<t;n+=1){let t=new K(new q(3.02,.04,3.02),r);t.position.y=n,e.add(t)}return{mesh:e,tier:X.L,points:120,volume:60,name:`IT Park`,objectRadius:2}}function bl(){let e=new cn,t=new K(new _i(.3,.5,2,8),Q(Z.treeTrunk));t.position.y=1,e.add(t);let n=new K(new xi(1.8,8,6),Q(Z.treeDarkGreen));n.position.y=2.8,n.scale.set(1,.6,1),e.add(n);for(let t=0;t<4;t++){let n=t/4*Math.PI*2,r=new K(new _i(.03,.03,1.5,4),Q(Z.treeTrunk));r.position.set(Math.cos(n)*1,1.2,Math.sin(n)*1),e.add(r)}return{mesh:e,tier:X.M,points:35,volume:10,name:`Banyan Tree`,objectRadius:1.8}}function xl(){let e=new cn,t=new K(new q(6,.4,4),Q(13621468));t.position.y=.2,e.add(t);let n=new Mi({color:11789820,transparent:!0,opacity:.4,flatShading:!0,roughness:.1,metalness:.3}),r=new K(new q(5.5,2,3.5),n);r.position.y=1.4,e.add(r);let i=new K(new _i(2,2,5.5,12,1,!1,0,Math.PI),n);i.rotation.z=Math.PI/2,i.rotation.y=Math.PI/2,i.position.y=2.4,e.add(i);let a=Q(5533306);for(let t=-2;t<=2;t+=1){let n=new K(new Si(1.8,.04,4,12,Math.PI),a);n.position.set(t,2.4,0),e.add(n)}return{mesh:e,tier:X.XL,points:500,volume:200,name:`Lalbagh Glasshouse`,objectRadius:4}}function Sl(){let e=new cn,t=new K(new q(1.5,1.2,1.2),Q(5125166));t.position.y=.6,e.add(t);let n=new K(new q(1,.3,.05),Q(16763906));n.position.set(0,1.4,.63),e.add(n);let r=new K(new q(1.7,.05,.6),Q(13840175));r.position.set(0,1.15,.9),r.rotation.x=.15,e.add(r);let i=new K(new _i(.15,.15,.4,6),Q(9268835));return i.position.set(.5,.2,1),e.add(i),{mesh:e,tier:X.S,points:30,volume:5,name:`Coffee Shop`,objectRadius:.8}}function Cl(){let e=new cn,t=new K(new q(.7,.3,.25),Q(2171169));t.position.y=.35,e.add(t);let n=new K(new q(.3,.08,.2),Q(4342338));n.position.set(-.1,.55,0),e.add(n);let r=new K(new _i(.02,.02,.4,4),Q(7697781));r.position.set(.3,.35,0),r.rotation.z=.3,e.add(r);let i=Q(3355443);for(let t of[-.25,.3]){let n=new K(new Si(.12,.03,6,12),i);n.position.set(t,.15,0),e.add(n)}let a=new K(new xi(.04,6,4),Q(16772696));return a.position.set(.38,.5,0),e.add(a),{mesh:e,tier:X.S,points:30,volume:4,name:`Motorcycle`,objectRadius:.4}}function wl(){let e=new cn,t=new K(new _i(.4,.5,4,8),Q(7901340));t.position.y=2,e.add(t);let n=new K(new q(3,.5,1.5),Q(9479342));n.position.y=4.25,e.add(n);let r=new K(new q(3.02,.15,1.52),Q(8069026));return r.position.y=4.05,e.add(r),{mesh:e,tier:X.L,points:90,volume:45,name:`Metro Pillar`,objectRadius:1.5}}function Tl(e,t,n){return e+(t-e)*n}function El(e,t,n){return Math.max(t,Math.min(n,e))}function Dl(e,t,n,r){let i=n-e,a=r-t;return Math.sqrt(i*i+a*a)}function Ol(e,t){return e+Math.random()*(t-e)}var $=160/2,kl=[{name:`Yeshwanthpur`,x:-55,z:-55,w:30,h:30,type:`commercial`,density:.7,color:5125166},{name:`Malleshwaram`,x:-25,z:-55,w:30,h:30,type:`old_city`,density:.8,color:6111287},{name:`Sadashivanagar`,x:5,z:-55,w:30,h:30,type:`residential`,density:.5,color:4086830},{name:`Cantonment`,x:35,z:-55,w:30,h:30,type:`old_city`,density:.6,color:5125166},{name:`Hebbal`,x:65,z:-55,w:30,h:30,type:`residential`,density:.5,color:4086830},{name:`Rajajinagar`,x:-55,z:-20,w:30,h:25,type:`residential`,density:.6,color:4086830},{name:`Majestic`,x:-25,z:-20,w:30,h:25,type:`commercial`,density:.9,color:4545124},{name:`Cubbon Park`,x:5,z:-20,w:30,h:25,type:`park`,density:.3,color:1793568},{name:`MG Road`,x:35,z:-20,w:30,h:25,type:`commercial`,density:.9,color:4545124},{name:`Indiranagar`,x:65,z:-20,w:30,h:25,type:`commercial`,density:.8,color:3622735},{name:`Vijayanagar`,x:-55,z:8,w:30,h:25,type:`residential`,density:.5,color:4086830},{name:`Basavanagudi`,x:-25,z:8,w:30,h:25,type:`old_city`,density:.7,color:6111287},{name:`Lalbagh`,x:5,z:8,w:30,h:25,type:`park`,density:.3,color:1793568},{name:`Koramangala`,x:35,z:8,w:30,h:25,type:`commercial`,density:.8,color:3622735},{name:`HAL`,x:65,z:8,w:30,h:25,type:`it_hub`,density:.6,color:2503224},{name:`RR Nagar`,x:-55,z:38,w:30,h:30,type:`residential`,density:.5,color:4086830},{name:`Jayanagar`,x:-25,z:38,w:30,h:30,type:`residential`,density:.7,color:4086830},{name:`BTM Layout`,x:5,z:38,w:30,h:30,type:`residential`,density:.7,color:3369246},{name:`HSR Layout`,x:35,z:38,w:30,h:30,type:`it_hub`,density:.7,color:2503224},{name:`Whitefield`,x:65,z:38,w:30,h:30,type:`it_hub`,density:.8,color:2503224}],Al=[{x1:-$,z1:-7,x2:$,z2:-7,width:5,name:`MG Road / Bellary Road`},{x1:-$,z1:-35,x2:$,z2:-35,width:4,name:`Seshadri Road`},{x1:-$,z1:22,x2:$,z2:22,width:4,name:`Hosur Road`},{x1:-$,z1:50,x2:$,z2:50,width:3,name:`Bannerghatta Road`},{x1:-$,z1:-65,x2:$,z2:-65,width:3,name:`ORR North`},{x1:5,z1:-$,x2:5,z2:$,width:5,name:`Namma Metro (Purple)`},{x1:-25,z1:-$,x2:-25,z2:$,width:4,name:`Tumkur Road`},{x1:35,z1:-$,x2:35,z2:$,width:4,name:`100 Feet Road`},{x1:-55,z1:-$,x2:-55,z2:$,width:3,name:`Mysore Road`},{x1:65,z1:-$,x2:65,z2:$,width:3,name:`Old Airport Road`},{x1:-$,z1:-50,x2:$,z2:-50,width:2.5,name:`Palace Road`},{x1:-$,z1:-20,x2:$,z2:-20,width:2.5,name:`Residency Road`},{x1:-$,z1:8,x2:$,z2:8,width:2.5,name:`Lalbagh Road`},{x1:-$,z1:35,x2:$,z2:35,width:2.5,name:`JP Nagar Road`},{x1:-40,z1:-$,x2:-40,z2:$,width:2.5,name:`Bull Temple Road`},{x1:-10,z1:-$,x2:-10,z2:$,width:2.5,name:`KR Road`},{x1:20,z1:-$,x2:20,z2:$,width:2.5,name:`St Marks Road`},{x1:50,z1:-$,x2:50,z2:$,width:2.5,name:`HAL Road`},{x1:-$,z1:-42,x2:$,z2:-42,width:1.8,name:``},{x1:-$,z1:-28,x2:$,z2:-28,width:1.8,name:``},{x1:-$,z1:-12,x2:$,z2:-12,width:1.8,name:``},{x1:-$,z1:15,x2:$,z2:15,width:1.8,name:``},{x1:-$,z1:28,x2:$,z2:28,width:1.8,name:``},{x1:-$,z1:42,x2:$,z2:42,width:1.8,name:``},{x1:-48,z1:-$,x2:-48,z2:$,width:1.8,name:``},{x1:-33,z1:-$,x2:-33,z2:$,width:1.8,name:``},{x1:-18,z1:-$,x2:-18,z2:$,width:1.8,name:``},{x1:-3,z1:-$,x2:-3,z2:$,width:1.8,name:``},{x1:12,z1:-$,x2:12,z2:$,width:1.8,name:``},{x1:28,z1:-$,x2:28,z2:$,width:1.8,name:``},{x1:42,z1:-$,x2:42,z2:$,width:1.8,name:``},{x1:57,z1:-$,x2:57,z2:$,width:1.8,name:``},{x1:72,z1:-$,x2:72,z2:$,width:1.8,name:``}];function jl(e){let t=new Mi({color:2894892,roughness:.95});for(let n of Al){let r=n.x2-n.x1,i=n.z2-n.z1,a=Math.sqrt(r*r+i*i),o=new K(Math.abs(r)>Math.abs(i)?new yi(a,n.width):new yi(n.width,a),t);o.rotation.x=-Math.PI/2,o.position.set((n.x1+n.x2)/2,.01,(n.z1+n.z2)/2),o.renderOrder=1,e.add(o)}let n=new Vr({color:16771899});for(let t of Al){let r=t.x2-t.x1,i=t.z2-t.z1,a=Math.sqrt(r*r+i*i),o=Math.abs(r)>Math.abs(i),s=Math.floor(a/4);for(let a=0;a<s;a+=2){let c=(a+.5)/s,l=new K(new yi(o?2:.12,o?.12:2),n);l.rotation.x=-Math.PI/2,l.position.set(t.x1+r*c,.02,t.z1+i*c),l.renderOrder=1,e.add(l)}}}function Ml(e,t,n=2){for(let r of Al)if(Math.abs(r.x2-r.x1)>Math.abs(r.z2-r.z1)){let i=Math.min(r.x1,r.x2),a=Math.max(r.x1,r.x2);if(e>=i&&e<=a&&Math.abs(t-r.z1)<r.width/2+n)return!0}else{let i=Math.min(r.z1,r.z2),a=Math.max(r.z1,r.z2);if(t>=i&&t<=a&&Math.abs(e-r.x1)<r.width/2+n)return!0}return!1}function Nl(e,t,n=5){return Ml(e,t,n)}function Pl(e){for(let t of kl){let n=new Mi({color:t.type===`park`?2976304:t.color,roughness:.92}),r=new K(new yi(t.w,t.h),n);if(r.rotation.x=-Math.PI/2,r.position.set(t.x,.005,t.z),r.renderOrder=0,e.add(r),t.type===`park`){let n=new Mi({color:1793568,flatShading:!0}),r=[{sx:t.w,sz:.3,px:t.x,pz:t.z-t.h/2},{sx:t.w,sz:.3,px:t.x,pz:t.z+t.h/2},{sx:.3,sz:t.h,px:t.x-t.w/2,pz:t.z},{sx:.3,sz:t.h,px:t.x+t.w/2,pz:t.z}];for(let t of r){let r=new K(new q(t.sx,.3,t.sz),n);r.position.set(t.px,.15,t.pz),e.add(r)}}}}function Fl(e){let t=document.createElement(`canvas`),n=t.getContext(`2d`);t.width=256,t.height=64;for(let r of kl){n.clearRect(0,0,256,64),n.fillStyle=r.type===`park`?`#a5d6a7`:`#b0bec5`,n.font=`bold 28px system-ui, sans-serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(r.name,128,32);let i=new di(t);i.needsUpdate=!0;let a=new _r({map:i.clone(),transparent:!0,opacity:.7,depthTest:!1});a.map.needsUpdate=!0;let o=new jr(a);o.position.set(r.x,6,r.z),o.scale.set(10,2.5,1),o.renderOrder=10,e.add(o)}}function Il(e,t,n,r,i=()=>!0){let a=0,o=0;for(;a<r&&o<r*8;){o++;let r=Ol(-$+5,$-5),s=Ol(-$+5,$-5);if(!i(r,s)||t.some(e=>Math.abs(e.x-r)<1.5&&Math.abs(e.z-s)<1.5))continue;let c=n();c.mesh.position.set(r,0,s),c.mesh.rotation.y=Math.random()*Math.PI*2,e.add(c.mesh),t.push({...c,x:r,z:s,consumed:!1,consuming:!1,consumeProgress:0,originalY:0,originalScale:1,holeX:0,holeZ:0}),a++}}function Ll(e,t,n,r,i,a=()=>!0){let o=0,s=0;for(;o<r&&s<r*10;){s++;let r=Ol(i.x-i.w/2+1,i.x+i.w/2-1),c=Ol(i.z-i.h/2+1,i.z+i.h/2-1);if(!a(r,c)||t.some(e=>Math.abs(e.x-r)<1.2&&Math.abs(e.z-c)<1.2))continue;let l=n();l.mesh.position.set(r,0,c),l.mesh.rotation.y=Math.random()*Math.PI*2,e.add(l.mesh),t.push({...l,x:r,z:c,consumed:!1,consuming:!1,consumeProgress:0,originalY:0,originalScale:1,holeX:0,holeZ:0}),o++}}function Rl(e){let t=[];Pl(e),Fl(e),Il(e,t,al,80,(e,t)=>Nl(e,t,3)),Il(e,t,cl,70,(e,t)=>Nl(e,t,3)),Il(e,t,ll,100,(e,t)=>!Ml(e,t,0)),Il(e,t,Cl,50,(e,t)=>Nl(e,t,4)),Il(e,t,fl,60,(e,t)=>Nl(e,t,4)),Il(e,t,pl,40,(e,t)=>Nl(e,t,4)),Il(e,t,ml,18,(e,t)=>Nl(e,t,4)),Il(e,t,ol,60),Il(e,t,ul,50,(e,t)=>!Ml(e,t,1)),Il(e,t,sl,30,(e,t)=>Nl(e,t,5));for(let n of kl){let r=(e,t)=>!Ml(e,t,1),i=(e,t)=>Nl(e,t,4),a=n.w*n.h/400;switch(n.type){case`commercial`:case`market`:Ll(e,t,hl,Math.floor(12*n.density*a),n,r),Ll(e,t,Sl,Math.floor(8*n.density*a),n,r),Ll(e,t,sl,Math.floor(8*n.density*a),n,i),Ll(e,t,ll,Math.floor(10*n.density*a),n,r),Ll(e,t,dl,Math.floor(4*n.density*a),n,r),Ll(e,t,fl,Math.floor(5*n.density*a),n,i);break;case`residential`:Ll(e,t,hl,Math.floor(10*n.density*a),n,r),Ll(e,t,ul,Math.floor(8*n.density*a),n,r),Ll(e,t,ol,Math.floor(6*n.density*a),n),Ll(e,t,ll,Math.floor(6*n.density*a),n,r),Ll(e,t,pl,Math.floor(4*n.density*a),n,i);break;case`it_hub`:Ll(e,t,yl,Math.floor(6*n.density*a),n,r),Ll(e,t,hl,Math.floor(5*n.density*a),n,r),Ll(e,t,pl,Math.floor(8*n.density*a),n,i),Ll(e,t,ll,Math.floor(6*n.density*a),n,r),Ll(e,t,Sl,Math.floor(3*n.density*a),n,r);break;case`old_city`:Ll(e,t,hl,Math.floor(8*n.density*a),n,r),Ll(e,t,Sl,Math.floor(6*n.density*a),n,r),Ll(e,t,sl,Math.floor(7*n.density*a),n,i),Ll(e,t,bl,Math.floor(4*n.density*a),n,r),Ll(e,t,fl,Math.floor(6*n.density*a),n,i),Ll(e,t,ll,Math.floor(8*n.density*a),n,r);break;case`park`:Ll(e,t,ul,Math.floor(14*n.density*a),n),Ll(e,t,bl,Math.floor(6*n.density*a),n),Ll(e,t,dl,Math.floor(8*n.density*a),n),Ll(e,t,ll,Math.floor(10*n.density*a),n),Ll(e,t,ol,Math.floor(8*n.density*a),n);break}}for(let n=-$+10;n<$-10;n+=12)Il(e,t,wl,1,(e,t)=>Math.abs(e-5)<3&&Math.abs(t-n)<3);let n=[{factory:gl,x:8,z:-22},{factory:_l,x:-28,z:-50},{factory:vl,x:60,z:-20},{factory:xl,x:5,z:10}];for(let r of n){let n=r.factory();n.mesh.position.set(r.x,0,r.z),e.add(n.mesh),t.push({...n,x:r.x,z:r.z,consumed:!1,consuming:!1,consumeProgress:0,originalY:0,originalScale:1,holeX:0,holeZ:0})}return t}var zl=100,Bl=class{particles=[];pool=[];scene;constructor(e){this.scene=e;let t=new xi(.08,4,3),n=new Vr({color:12364452,transparent:!0});for(let r=0;r<zl;r++){let r=new K(t,n.clone());r.visible=!1,e.add(r),this.pool.push(r)}}burst(e,t,n,r=8,i=12364452){for(let a=0;a<r;a++){let o=this.pool.pop();if(!o)return;o.visible=!0,o.position.set(e,t+.2,n),o.material.color.setHex(i),o.material.opacity=1;let s=a/r*Math.PI*2+Math.random()*.5,c=2+Math.random()*3,l=2+Math.random()*3;this.particles.push({mesh:o,velocity:new H(Math.cos(s)*c,l,Math.sin(s)*c),life:0,maxLife:.4+Math.random()*.3})}}update(e){for(let t=this.particles.length-1;t>=0;t--){let n=this.particles[t];if(n.life+=e,n.life>=n.maxLife){n.mesh.visible=!1,this.pool.push(n.mesh),this.particles.splice(t,1);continue}let r=n.life/n.maxLife;n.mesh.position.x+=n.velocity.x*e,n.mesh.position.y+=n.velocity.y*e,n.mesh.position.z+=n.velocity.z*e,n.velocity.y-=10*e,n.mesh.material.opacity=1-r;let i=1-r*.5;n.mesh.scale.set(i,i,i)}}dispose(){for(let e of this.particles)this.scene.remove(e.mesh);for(let e of this.pool)this.scene.remove(e);this.particles=[],this.pool=[]}},Vl=class{ctx=null;enabled=!0;ensureContext(){return this.ctx||=new AudioContext,this.ctx.state===`suspended`&&this.ctx.resume(),this.ctx}playEat(e=0){if(!this.enabled)return;let t=this.ensureContext(),n=t.currentTime,r=300-e*40,i=t.createOscillator();i.type=`sine`,i.frequency.setValueAtTime(r,n),i.frequency.exponentialRampToValueAtTime(r*.3,n+.15);let a=t.createGain();a.gain.setValueAtTime(.3,n),a.gain.exponentialRampToValueAtTime(.01,n+.2),i.connect(a),a.connect(t.destination),i.start(n),i.stop(n+.2)}playBigEat(){if(!this.enabled)return;let e=this.ensureContext(),t=e.currentTime,n=e.createOscillator();n.type=`sawtooth`,n.frequency.setValueAtTime(150,t),n.frequency.exponentialRampToValueAtTime(40,t+.4);let r=e.createGain();r.gain.setValueAtTime(.25,t),r.gain.exponentialRampToValueAtTime(.01,t+.4);let i=e.createWaveShaper(),a=new Float32Array(256);for(let e=0;e<256;e++){let t=e*2/256-1;a[e]=Math.tanh(t*3)}i.curve=a,n.connect(i),i.connect(r),r.connect(e.destination),n.start(t),n.stop(t+.4)}playTierUp(){if(!this.enabled)return;let e=this.ensureContext(),t=e.currentTime;[400,500,600,800].forEach((n,r)=>{let i=e.createOscillator();i.type=`sine`,i.frequency.value=n;let a=e.createGain(),o=t+r*.08;a.gain.setValueAtTime(0,o),a.gain.linearRampToValueAtTime(.15,o+.02),a.gain.exponentialRampToValueAtTime(.01,o+.15),i.connect(a),a.connect(e.destination),i.start(o),i.stop(o+.15)})}playGameOver(){if(!this.enabled)return;let e=this.ensureContext(),t=e.currentTime,n=e.createOscillator();n.type=`triangle`,n.frequency.setValueAtTime(400,t),n.frequency.linearRampToValueAtTime(200,t+.5);let r=e.createGain();r.gain.setValueAtTime(.2,t),r.gain.linearRampToValueAtTime(0,t+.6),n.connect(r),r.connect(e.destination),n.start(t),n.stop(t+.6)}playDeath(){if(!this.enabled)return;let e=this.ensureContext(),t=e.currentTime,n=e.createOscillator();n.type=`sawtooth`,n.frequency.setValueAtTime(500,t),n.frequency.exponentialRampToValueAtTime(50,t+.5);let r=e.createGain();r.gain.setValueAtTime(.15,t),r.gain.exponentialRampToValueAtTime(.01,t+.5),n.connect(r),r.connect(e.destination),n.start(t),n.stop(t+.5)}toggle(){return this.enabled=!this.enabled,this.enabled}},Hl=[`MG Road Muncher`,`Koramangala Crusher`,`Indiranagar Eater`,`Whitefield Gobbler`,`Jayanagar Chomper`],Ul=[`#e91e63`,`#ff9800`,`#9c27b0`,`#00bcd4`,`#8bc34a`],Wl=120,Gl=2,Kl=50,ql=160/2;new class{renderer;camera;scene;loop;input;playerHole;playerX=0;playerZ=0;playerRadius=Gl;totalVolume=0;score=0;speed=15;aiHoles=[];objects=[];particles;audio=new Vl;lastTier=0;timer=Wl;gameState=`menu`;timerEl;scoreEl;sizeEl;hudEl;leaderboardEl;menuEl;gameOverEl;finalScoreEl;finalRankEl;sizeUpEl;minimapCanvas;minimapCtx;minimapEl;soundBtn;async init(){this.renderer=Zc(document.getElementById(`game-container`)),this.camera=Qc(),this.scene=$c(),this.input=new Xc,this.timerEl=document.getElementById(`timer`),this.scoreEl=document.getElementById(`score`),this.sizeEl=document.getElementById(`size-label`),this.hudEl=document.getElementById(`hud`),this.leaderboardEl=document.getElementById(`leaderboard`),this.menuEl=document.getElementById(`main-menu`),this.gameOverEl=document.getElementById(`game-over`),this.finalScoreEl=document.getElementById(`final-score`),this.finalRankEl=document.getElementById(`final-rank`),this.sizeUpEl=document.getElementById(`size-up`),this.minimapCanvas=document.getElementById(`minimap-canvas`),this.minimapCtx=this.minimapCanvas.getContext(`2d`),this.minimapEl=document.getElementById(`minimap`),this.soundBtn=document.getElementById(`sound-btn`),document.getElementById(`play-btn`).addEventListener(`click`,()=>this.startGame()),document.getElementById(`restart-btn`).addEventListener(`click`,()=>this.startGame()),this.soundBtn.addEventListener(`click`,()=>{let e=this.audio.toggle();this.soundBtn.textContent=e?`🔊`:`🔇`}),this.loop=new Yc(e=>this.update(e),e=>this.render()),this.loop.start()}startGame(){this.clearScene();let e=el.createGround(200);this.scene.add(e),jl(this.scene),this.createBoundary(),this.objects=Rl(this.scene),this.particles=new Bl(this.scene),this.playerHole=new el,this.scene.add(this.playerHole.group),this.playerX=35,this.playerZ=-15,this.playerRadius=Gl,this.totalVolume=0,this.score=0,this.speed=15,this.lastTier=0,this.playerHole.setPosition(this.playerX,this.playerZ),this.playerHole.setRadius(this.playerRadius),this.aiHoles=[];let t=[15277667,16750592,10233776,48340,9159498];for(let e=0;e<4;e++){let n=new el(t[e]);this.scene.add(n.group);let r=e/4*Math.PI*2;this.aiHoles.push({renderer:n,x:Math.cos(r)*25,z:Math.sin(r)*25,radius:Gl,totalVolume:0,score:0,speed:7+Math.random()*4,targetX:0,targetZ:0,name:Hl[e],color:Ul[e]})}this.timer=Wl,this.gameState=`playing`,this.menuEl.style.display=`none`,this.gameOverEl.style.display=`none`,this.hudEl.style.display=`flex`,this.leaderboardEl.style.display=`block`,this.minimapEl.style.display=`block`}clearScene(){let e=[];this.scene.traverse(t=>{(t instanceof K||t instanceof cn)&&e.push(t)});for(let t of e)t.removeFromParent();this.scene=$c()}createBoundary(){let e=new Vr({color:1713022,transparent:!0,opacity:.3}),t=[{x:0,z:-ql,sx:164,sz:2},{x:0,z:ql,sx:164,sz:2},{x:-ql,z:0,sx:2,sz:164},{x:ql,z:0,sx:2,sz:164}];for(let n of t){let t=new K(new q(n.sx,3,n.sz),e);t.position.set(n.x,3/2,n.z),t.renderOrder=3,this.scene.add(t)}}update(e){if(this.gameState!==`playing`)return;if(this.timer-=e,this.timer<=0){this.timer=0,this.endGame();return}let t=this.input.getMovement(),n=this.speed*(1-this.playerRadius*.01);this.playerX+=t.x*n*e,this.playerZ+=t.z*n*e,this.playerX=El(this.playerX,-ql+2,ql-2),this.playerZ=El(this.playerZ,-ql+2,ql-2),this.playerHole.setPosition(this.playerX,this.playerZ),this.checkConsumption(this.playerX,this.playerZ,this.playerRadius,!0),this.updateConsumingAnimations(e),this.particles.update(e),this.checkHoleVsHole(),this.updateAI(e),this.updateCamera(e),this.updateHUD(),this.updateMinimap()}checkHoleVsHole(){for(let e of this.aiHoles){if(!e.renderer.group.visible)continue;let t=Dl(this.playerX,this.playerZ,e.x,e.z);this.playerRadius>e.radius*1.3&&t<this.playerRadius*.6&&(e.renderer.group.visible=!1,this.totalVolume+=e.totalVolume*.5,this.playerRadius=Gl*(1+this.totalVolume/Kl)**(1/3),this.playerHole.setRadius(this.playerRadius),this.score+=200,this.particles.burst(e.x,.1,e.z,15,16732754),this.audio.playBigEat(),this.showScorePopup(e.x,e.z,200)),e.radius>this.playerRadius*1.3&&t<e.radius*.6&&(this.playerX=Ol(-ql+10,ql-10),this.playerZ=Ol(-ql+10,ql-10),this.totalVolume=Math.max(0,this.totalVolume*.3),this.playerRadius=Gl*(1+this.totalVolume/Kl)**(1/3),this.playerHole.setRadius(this.playerRadius),this.score=Math.max(0,this.score-100),this.particles.burst(this.playerX,.1,this.playerZ,10,5227511),this.audio.playDeath())}}checkConsumption(e,t,n,r){let i=0;for(let a of this.objects){if(a.consumed||a.consuming||n<a.objectRadius)continue;let o=Dl(e,t,a.x,a.z);if(o<n*2&&o>n*.2){let r=.06*(1-o/(n*2)),i=e-a.x,s=t-a.z,c=Math.sqrt(i*i+s*s)||1;a.x+=i/c*r,a.z+=s/c*r,a.mesh.position.x=a.x,a.mesh.position.z=a.z,o=Dl(e,t,a.x,a.z)}if(o<n){if(a.consuming=!0,a.consumeProgress=0,a.originalY=a.mesh.position.y,a.originalScale=1,a.holeX=e,a.holeZ=t,this.particles.burst(a.x,.1,a.z,6+a.tier*2,12364452),r){this.totalVolume+=a.volume,this.playerRadius=Gl*(1+this.totalVolume/Kl)**(1/3),this.playerHole.setRadius(this.playerRadius),this.score+=a.points,this.audio.playEat(a.tier);let e=rl(this.playerRadius);e>this.lastTier&&(this.lastTier=e,this.audio.playTierUp(),this.showSizeUp(tl[e])),this.showScorePopup(a.x,a.z,a.points)}i++}}return i}updateConsumingAnimations(e){for(let t of this.objects)if(t.consuming)if(t.consumeProgress+=e*2.5,t.consumeProgress>=1)t.consumed=!0,t.consuming=!1,t.mesh.visible=!1;else{let n=t.consumeProgress,r=1-n;t.mesh.scale.set(r,r,r),t.mesh.position.x=Tl(t.x,t.holeX,n*n),t.mesh.position.z=Tl(t.z,t.holeZ,n*n),t.mesh.position.y=t.originalY-n*n*4,t.mesh.rotation.y+=e*(8+n*15)}}scorePopups=[];showScorePopup(e,t,n){let r=document.createElement(`div`);r.textContent=`+${n}`,r.style.cssText=`
    ...
    `;let i=new H(e,2,t);i.project(this.camera);let a=(i.x*.5+.5)*window.innerWidth,o=(-i.y*.5+.5)*window.innerHeight;r.style.left=`${a}px`,r.style.top=`${o}px`,document.getElementById(`ui-overlay`).appendChild(r),requestAnimationFrame(()=>{r.style.transform=`translateY(-60px)`,r.style.opacity=`0`}),this.scorePopups.push({el:r,life:0}),setTimeout(()=>{r.remove(),this.scorePopups=this.scorePopups.filter(e=>e.el!==r)},900)}sizeUpTimeout=null;showSizeUp(e){this.sizeUpEl.textContent=`SIZE UP! ${e}`,this.sizeUpEl.classList.add(`show`),this.sizeUpTimeout&&clearTimeout(this.sizeUpTimeout),this.sizeUpTimeout=setTimeout(()=>{this.sizeUpEl.classList.remove(`show`)},1500)}updateMinimap(){let e=this.minimapCtx,t=100/160;e.clearRect(0,0,100,100),e.fillStyle=`#2d5a3e`,e.fillRect(0,0,100,100),e.fillStyle=`#37474f`,e.fillRect(0,100/2-2,100,4),e.fillRect(100/2-2,0,4,100);for(let n of this.aiHoles){if(!n.renderer.group.visible)continue;let r=(n.x+160/2)*t,i=(n.z+160/2)*t;e.fillStyle=n.color,e.beginPath(),e.arc(r,i,Math.max(2,n.radius*t),0,Math.PI*2),e.fill()}let n=(this.playerX+160/2)*t,r=(this.playerZ+160/2)*t;e.fillStyle=`#4fc3f7`,e.beginPath(),e.arc(n,r,Math.max(3,this.playerRadius*t),0,Math.PI*2),e.fill(),e.strokeStyle=`#fff`,e.lineWidth=1,e.stroke()}updateAI(e){for(let t of this.aiHoles){if(Dl(t.x,t.z,t.targetX,t.targetZ)<2||Math.random()<.02){let e=null,n=1/0;for(let r of this.objects){if(r.consumed||r.consuming||!il(t.radius,r.tier))continue;let i=Dl(t.x,t.z,r.x,r.z);i<n&&(n=i,e=r)}e?(t.targetX=e.x,t.targetZ=e.z):(t.targetX=Ol(-ql+10,ql-10),t.targetZ=Ol(-ql+10,ql-10))}let n=0,r=0;if(this.playerRadius>t.radius*1.3&&Dl(t.x,t.z,this.playerX,this.playerZ)<this.playerRadius*3){let e=t.x-this.playerX,i=t.z-this.playerZ,a=Math.sqrt(e*e+i*i)||1;n=e/a*2,r=i/a*2}let i=t.targetX-t.x+n,a=t.targetZ-t.z+r,o=Math.sqrt(i*i+a*a)||1,s=t.speed*(1-t.radius*.008);t.x+=i/o*s*e,t.z+=a/o*s*e,t.x=El(t.x,-ql+2,ql-2),t.z=El(t.z,-ql+2,ql-2),t.renderer.setPosition(t.x,t.z);for(let e of this.objects)e.consumed||e.consuming||t.radius<e.objectRadius||Dl(t.x,t.z,e.x,e.z)<t.radius&&(e.consuming=!0,e.consumeProgress=0,e.originalY=e.mesh.position.y,e.holeX=t.x,e.holeZ=t.z,this.particles.burst(e.x,.1,e.z,4,12364452),t.totalVolume+=e.volume,t.radius=Gl*(1+t.totalVolume/Kl)**(1/3),t.renderer.setRadius(t.radius),t.score+=e.points)}}updateCamera(e){let t=15+this.playerRadius*3,n=10+this.playerRadius*2;this.camera.position.x=Tl(this.camera.position.x,this.playerX,.05),this.camera.position.z=Tl(this.camera.position.z,this.playerZ+n,.05),this.camera.position.y=Tl(this.camera.position.y,t,.05),this.camera.lookAt(Tl(this.camera.position.x,this.playerX,.5),0,Tl(this.camera.position.z-n,this.playerZ,.5))}updateHUD(){let e=Math.floor(this.timer/60),t=Math.floor(this.timer%60);this.timerEl.textContent=`${e}:${t.toString().padStart(2,`0`)}`,this.scoreEl.textContent=`Score: ${this.score}`;let n=rl(this.playerRadius);this.sizeEl.textContent=`Size: ${tl[n]}`;let r=[{name:`You`,score:this.score,isPlayer:!0},...this.aiHoles.map(e=>({name:e.name,score:e.score,isPlayer:!1}))].sort((e,t)=>t.score-e.score);this.leaderboardEl.innerHTML=`<h3>Leaderboard</h3>`+r.map((e,t)=>`<div class="lb-entry${e.isPlayer?` player`:``}"><span>${t+1}. ${e.name}</span><span>${e.score}</span></div>`).join(``)}endGame(){this.gameState=`gameover`,this.audio.playGameOver();let e=[{name:`You`,score:this.score,isPlayer:!0},...this.aiHoles.map(e=>({name:e.name,score:e.score,isPlayer:!1}))].sort((e,t)=>t.score-e.score),t=e.findIndex(e=>e.isPlayer)+1;this.finalScoreEl.textContent=`Score: ${this.score}`,this.finalRankEl.textContent=`Rank: #${t} of ${e.length}`,this.hudEl.style.display=`none`,this.leaderboardEl.style.display=`none`,this.minimapEl.style.display=`none`,this.gameOverEl.style.display=`flex`}render(){this.renderer.render(this.scene,this.camera)}}().init().catch(console.error);